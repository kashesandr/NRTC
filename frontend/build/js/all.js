...
/*
 AngularJS v1.4.0-build.3895+sha.2b4dfa9
 (c) 2010-2015 Google, Inc. http://angularjs.org
 License: MIT
*/
(function(P,W,u){'use strict';function E(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.4.0-build.3895+sha.2b4dfa9/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Pa(b){if(null==b||Qa(b))return!1;var a=b.length;
...
d);c(b)(a)})}]);return d},e=/^NG_ENABLE_DEBUG_INFO!/,f=/^NG_DEFER_BOOTSTRAP!/;P&&e.test(P.name)&&(c.debugInfoEnabled=!0,P.name=P.name.replace(e,""));if(P&&!f.test(P.name))return d();P.name=P.name.replace(f,"");ba.resumeBootstrap=function(b){m(b,function(b){a.push(b)});return d()};G(ba.resumeDeferredBootstrap)&&ba.resumeDeferredBootstrap()}function Td(){P.name="NG_ENABLE_DEBUG_INFO!"+P.name;P.location.reload()}function Ud(b){b=ba.element(b).injector();if(!b)throw Ca("test");return b.get("$$testability")}
function wc(b,a){a=a||"_";return b.replace(Vd,function(b,d){return(d?a:"")+b.toLowerCase()})}function Wd(){var b;if(!xc){var a=jb();ka=P.jQuery;A(a)&&(ka=null===a?u:P[a]);ka&&ka.fn.on?(C=ka,O(ka.fn,{scope:Ka.scope,isolateScope:Ka.isolateScope,controller:Ka.controller,injector:Ka.injector,inheritedData:Ka.inheritedData}),b=ka.cleanData,ka.cleanData=function(a){var d;if(Pb)Pb=!1;else for(var e=0,f;null!=(f=a[e]);e++)(d=ka._data(f,"events"))&&d.$destroy&&ka(f).triggerHandler("$destroy");b(a)}):C=S;ba.element=
...
c.$get=function(){var a=y.invoke(d,c);return y.invoke(b,null,{$delegate:a})}}}},s=n.$injector=h(n,function(a,b){ba.isString(b)&&k.push(b);throw Fa("unpr",k.join(" <- "));}),r={},y=r.$injector=h(r,function(a,b){var c=s.get(a+"Provider",b);return y.invoke(c.$get,c,u,a)});m(g(b),function(a){y.invoke(a||B)});return y}function Ke(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location","$rootScope",function(a,c,d){function e(a){var b=null;Array.prototype.some.call(a,function(a){if("a"===
...
Ma&&(d=aa);c||(c=Ma?ma.parent():ma);return g(a,b,d,c,da)}var n,r,L,v,aa,z,ma;b===e?(f=d,ma=d.$$element):(ma=C(e),f=new ca(ma,d));w&&(v=c.$new(!0));g&&(z=s,z.$$boundTransclude=g);Q&&(aa=M(ma,f,z,Q,v,c));w&&(D.$$addScopeInfo(ma,v,!0,!(Y&&(Y===w||Y===w.$$originalDirective))),D.$$addScopeClass(ma,!0),v.$$isolateBindings=w.$$isolateBindings,ba(c,f,v,v.$$isolateBindings,w,v));if(aa){var m=w||N,na;m&&aa[m.name]&&(r=m.$$bindings.bindToController,(L=aa[m.name])&&L.identifier&&r&&(na=L,h.$$destroyBindings=
ba(c,f,L.instance,r,m)));for(n in aa){L=aa[n];var cb=L();cb!==L.instance&&L===na&&(h.$$destroyBindings(),h.$$destroyBindings=ba(c,f,cb,r,m))}}n=0;for(h=k.length;n<h;n++)r=k[n],$(r,r.isolateScope?v:c,ma,f,r.require&&p(r.directiveName,r.require,ma,aa),z);var da=c;w&&(w.template||null===w.templateUrl)&&(da=v);a&&a(da,e.childNodes,u,g);for(n=l.length-1;0<=n;n--)r=l[n],$(r,r.isolateScope?v:c,ma,f,r.require&&p(r.directiveName,r.require,ma,aa),z)}s=s||{};for(var L=-Number.MAX_VALUE,N,Q=s.controllerDirectives,
w=s.newIsolateScopeDirective,Y=s.templateDirective,z=s.nonTlbTranscludeDirective,m=!1,da=!1,Ma=s.hasElementTranscludeDirective,x=d.$$element=C(b),J,B,U,E=e,ya,K=0,O=a.length;K<O;K++){J=a[K];var yb=J.$$start,R=J.$$end;yb&&(x=cb(b,yb,R));U=u;if(L>J.priority)break;if(U=J.scope)J.templateUrl||(H(U)?(Na("new/isolated scope",w||N,J,x),w=J):Na("new/isolated scope",w,J,x)),N=N||J;B=J.name;!J.templateUrl&&J.controller&&(U=J.controller,Q=Q||la(),Na("'"+B+"' controller",Q[B],J,x),Q[B]=J);if(U=J.transclude)m=
!0,J.$$tlb||(Na("transclusion",z,J,x),z=J),"element"==U?(Ma=!0,L=J.priority,U=x,x=d.$$element=C(W.createComment(" "+B+": "+d[B]+" ")),b=x[0],X(f,ra.call(U,0),b),E=D(U,e,L,g&&g.name,{nonTlbTranscludeDirective:z})):(U=C(Tb(b)).contents(),x.empty(),E=D(U,e));if(J.template)if(da=!0,Na("template",Y,J,x),Y=J,U=G(J.template)?J.template(x,d):J.template,U=ga(U),J.replace){g=J;U=Rb.test(U)?Uc(Wb(J.templateNamespace,T(U))):[];b=U[0];if(1!=U.length||b.nodeType!==pa)throw ha("tplrt",B,"");X(f,x,b);O={$attr:{}};
U=aa(b,[],O);var Xb=a.splice(K+1,a.length-(K+1));w&&A(U);a=a.concat(U).concat(Xb);P(d,O);O=a.length}else x.html(U);if(J.templateUrl)da=!0,Na("template",Y,J,x),Y=J,J.replace&&(g=J),y=S(a.splice(K,a.length-K),x,d,f,m&&E,k,l,{controllerDirectives:Q,newIsolateScopeDirective:w,templateDirective:Y,nonTlbTranscludeDirective:z}),O=a.length;else if(J.compile)try{ya=J.compile(x,d,E),G(ya)?n(null,ya,yb,R):ya&&n(ya.pre,ya.post,yb,R)}catch(V){c(V,va(x))}J.terminal&&(y.terminal=!0,L=Math.max(L,J.priority))}y.scope=
...
(a[f]=b,d[f]=c[f])})}function S(a,b,c,d,e,f,g,h){var k=[],l,s,n=b[0],p=a.shift(),r=Mb(p,{templateUrl:null,transclude:null,replace:null,$$originalDirective:p}),M=G(p.templateUrl)?p.templateUrl(b,c):p.templateUrl,D=p.templateNamespace;b.empty();y(da.getTrustedResourceUrl(M)).then(function(y){var N,v;y=ga(y);if(p.replace){y=Rb.test(y)?Uc(Wb(D,T(y))):[];N=y[0];if(1!=y.length||N.nodeType!==pa)throw ha("tplrt",p.name,M);y={$attr:{}};X(d,b,N);var w=aa(N,[],y);H(p.scope)&&A(w);a=w.concat(a);P(c,y)}else N=
n,b.html(y);a.unshift(r);l=t(a,N,c,e,b,p,f,g,h);m(d,function(a,c){a==N&&(d[c]=b[0])});for(s=Y(b[0].childNodes,e);k.length;){y=k.shift();v=k.shift();var z=k.shift(),na=k.shift(),w=b[0];if(!y.$$destroyed){if(v!==n){var da=v.className;h.hasElementTranscludeDirective&&p.replace||(w=Tb(N));X(z,C(v),w);L(C(w),da)}v=l.transcludeOnThisElement?Q(y,l.transclude,na):na;l(s,y,w,d,v,l)}}k=null});return function(a,b,c,d,e){a=e;b.$$destroyed||(k?k.push(b,c,d,a):(l.transcludeOnThisElement&&(a=Q(b,l.transclude,e)),
...
""+a;break;default:a=Xa(a)}c=a}return c}catch(g){c=$b("interr",f,g.toString()),d(c)}}q=!!q;for(var p,w,m=0,z=[],M=[],L=f.length,D=[],Y=[];m<L;)if(-1!=(p=f.indexOf(b,m))&&-1!=(w=f.indexOf(a,p+l)))m!==p&&D.push(g(f.substring(m,p))),m=f.substring(p+l,w),z.push(m),M.push(c(m,v)),m=w+k,Y.push(D.length),D.push("");else{m!==L&&D.push(g(f.substring(m)));break}if(n&&1<D.length)throw $b("noconcat",f);if(!h||z.length){var Q=function(a){for(var b=0,c=z.length;b<c;b++){if(q&&x(a[b]))return;D[Y[b]]=a[b]}return D.join("")};
...
"$location",function(b,a,c){return{findBindings:function(a,b,c){a=a.getElementsByClassName("ng-binding");var g=[];m(a,function(a){var d=ba.element(a).data("$binding");d&&m(d,function(d){c?(new RegExp("(^|\\s)"+nd(b)+"(\\s|\\||$)")).test(d)&&g.push(a):-1!=d.indexOf(b)&&g.push(a)})});return g},findModels:function(a,b,c){for(var g=["ng-","data-ng-","ng\\:"],h=0;h<g.length;++h){var l=a.querySelectorAll("["+g[h]+"model"+(c?"=":"*=")+'"'+b+'"]');if(l.length)return l}},getLocation:function(){return c.url()},
...
f.cancel=function(b){return b&&b.$$timeoutId in g?(g[b.$$timeoutId].reject("canceled"),delete g[b.$$timeoutId],a.defer.cancel(b.$$timeoutId)):!1};return f}]}function za(b){db&&(X.setAttribute("href",b),b=X.href);X.setAttribute("href",b);return{href:X.href,protocol:X.protocol?X.protocol.replace(/:$/,""):"",host:X.host,search:X.search?X.search.replace(/^\?/,""):"",hash:X.hash?X.hash.replace(/^#/,""):"",hostname:X.hostname,port:X.port,pathname:"/"===X.pathname.charAt(0)?X.pathname:"/"+X.pathname}}function $c(b){b=
...
c,d,e,g){this.selectValue=a;this.viewValue=c;this.label=d;this.group=e;this.disabled=g}var m=a.match(mg);if(!m)throw lg("iexp",a,va(d));var n=m[5]||m[7],s=m[6];a=/ as /.test(m[0])&&m[1];d=m[9];var r=c(m[2]?m[1]:n),t=a&&c(a)||r,u=d&&c(d),v=d?function(a,c){return u(e,c)}:function(a){return Ea(a)},p=c(m[2]||m[1]),w=c(m[3]||""),x=c(m[4]||""),z=c(m[8]),M={},L=s?function(a,c){M[s]=c;M[n]=a;return M}:function(a){M[n]=a;return M};return{getWatchables:c(z,function(a){var c=[];a=a||[];Object.keys(a).forEach(function(d){var f=
L(a[d],d);d=v(a[d],f);c.push(d);m[2]&&(d=p(e,f),c.push(d));m[4]&&(f=x(e,f),c.push(f))});return c}),getOptions:function(){var a=[],c={},d=z(e)||[];Object.keys(d).forEach(function(g){if("$"!==g.charAt(0)){var h=L(d[g],g),m=t(e,h);g=v(m,h);var n=p(e,h),q=w(e,h),h=x(e,h),m=new f(g,m,n,q,h);a.push(m);c[g]=m}});return{items:a,selectValueMap:c,getOptionFromViewValue:function(a){return c[v(a,L(a))]}}}}}var e=W.createElement("option"),f=W.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select",
"?ngModel"],link:function(c,h,l,k){function q(a,c){a.element=c;c.disabled=a.disabled;a.value!==c.value&&(c.value=a.selectValue);a.label!==c.label&&(c.label=a.label,c.textContent=a.label)}function n(a,c,d,e){c&&K(c.nodeName)===d?d=c:(d=e.cloneNode(!1),c?a.insertBefore(d,c):a.appendChild(d));return d}function s(a){for(var c;a;)c=a.nextSibling,Vb(a),a=c}function r(a){var c=p&&p[0],d=x&&x[0];if(c||d)for(;a&&(a===c||a===d);)a=a.nextSibling;return a}function t(){var a=z&&v.readValue();z=M.getOptions();
var c={},d=h[0].firstChild;w&&h.prepend(p);d=r(d);z.items.forEach(function(a){var g,k;a.group?(g=c[a.group],g||(g=n(h[0],d,"optgroup",f),d=g.nextSibling,g.label=a.group,g=c[a.group]={groupElement:g,currentOptionElement:g.firstChild}),k=n(g.groupElement,g.currentOptionElement,"option",e),q(a,k),g.currentOptionElement=k.nextSibling):(k=n(h[0],d,"option",e),q(a,k),d=k.nextSibling)});Object.keys(c).forEach(function(a){s(c[a].currentOptionElement)});s(d);u.$render();if(!u.$isEmpty(a)){var g=v.readValue();
ja(a,g)||u.$setViewValue(g)}}var u=k[1];if(u){var v=k[0];k=l.multiple;var p=v.emptyOption,w=!!p,x=C(e.cloneNode(!1));x.val("?");var z,M=d(l.ngOptions,h,c);v.writeValue=function(a){var c=z.getOptionFromViewValue(a);c&&!c.disabled?h[0].value!==c.selectValue&&(x.remove(),w||p.remove(),h[0].value=c.selectValue,c.element.selected=!0,c.element.setAttribute("selected","selected")):null===a||w?(x.remove(),w||h.prepend(p),h.val(""),p.prop("selected",!0),p.attr("selected",!0)):(w||p.remove(),h.prepend(x),h.val("?"),
x.prop("selected",!0),x.attr("selected",!0))};v.readValue=function(){var a=z.selectValueMap[h.val()];return a&&!a.disabled?(w||p.remove(),x.remove(),a.viewValue):null};k&&(u.$isEmpty=function(a){return!a||0===a.length},v.writeValue=function(a){z.items.forEach(function(a){a.element.selected=!1});a&&a.forEach(function(a){(a=z.getOptionFromViewValue(a))&&!a.disabled&&(a.element.selected=!0)})},v.readValue=function(){var a=h.val()||[],c=[];m(a,function(a){a=z.selectValueMap[a];a.disabled||c.push(a.viewValue)});
return c});w?(p.remove(),a(p)(c),p.removeClass("ng-scope")):p=C(e.cloneNode(!1));t();c.$watchCollection(M.getWatchables,t)}}}}],ve=["$locale","$interpolate","$log",function(a,c,d){var e=/{}/g,f=/^when(Minus)?(.+)$/;return{restrict:"EA",link:function(g,h,l){function k(a){h.text(a||"")}var q=l.count,n=l.$attr.when&&h.attr(l.$attr.when),s=l.offset||0,r=g.$eval(n)||{},t={},u=c.startSymbol(),v=c.endSymbol(),p=u+q+"-"+s+v,w=ba.noop,A;m(l,function(a,c){var d=f.exec(c);d&&(d=(d[1]?"-":"")+K(d[2]),r[d]=h.attr(l.$attr[c]))});
m(r,function(a,d){t[d]=c(a.replace(e,p))});g.$watch(q,function(c){var e=parseFloat(c),f=isNaN(e);f||e in r||(e=a.pluralCat(e-s));e===A||f&&R(A)&&isNaN(A)||(w(),f=t[e],x(f)?(null!=c&&d.debug("ngPluralize: no rule defined for '"+e+"' in "+n),w=B,k()):w=g.$watch(f,k),A=e)})}}}],we=["$parse","$animate",function(a,c){var d=E("ngRepeat"),e=function(a,c,d,e,k,m,n){a[d]=e;k&&(a[k]=m);a.$index=c;a.$first=0===c;a.$last=c===n-1;a.$middle=!(a.$first||a.$last);a.$odd=!(a.$even=0===(c&1))};return{restrict:"A",
multiElement:!0,transclude:"element",priority:1E3,terminal:!0,$$tlb:!0,compile:function(f,g){var h=g.ngRepeat,l=W.createComment(" end ngRepeat: "+h+" "),k=h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!k)throw d("iexp",h);var q=k[1],n=k[2],s=k[3],r=k[4],k=q.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/);if(!k)throw d("iidexp",q);var t=k[3]||k[1],x=k[2];if(s&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(s)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(s)))throw d("badident",
s);var v,p,w,A,z={$id:Ea};r?v=a(r):(w=function(a,c){return Ea(c)},A=function(a){return a});return function(a,f,g,k,q){v&&(p=function(c,d,e){x&&(z[x]=c);z[t]=d;z.$index=e;return v(a,z)});var r=la();a.$watchCollection(n,function(g){var k,n,v=f[0],z,B=la(),D,G,H,F,I,E,K;s&&(a[s]=g);if(Pa(g))I=g,n=p||w;else for(K in n=p||A,I=[],g)g.hasOwnProperty(K)&&"$"!==K.charAt(0)&&I.push(K);D=I.length;K=Array(D);for(k=0;k<D;k++)if(G=g===I?k:I[k],H=g[G],F=n(G,H,k),r[F])E=r[F],delete r[F],B[F]=E,K[k]=E;else{if(B[F])throw m(K,
function(a){a&&a.scope&&(r[a.id]=a)}),d("dupes",h,F,H);K[k]={id:F,scope:u,clone:u};B[F]=!0}for(z in r){E=r[z];F=lb(E.clone);c.leave(F);if(F[0].parentNode)for(k=0,n=F.length;k<n;k++)F[k].$$NG_REMOVED=!0;E.scope.$destroy()}for(k=0;k<D;k++)if(G=g===I?k:I[k],H=g[G],E=K[k],E.scope){z=v;do z=z.nextSibling;while(z&&z.$$NG_REMOVED);E.clone[0]!=z&&c.move(lb(E.clone),null,C(v));v=E.clone[E.clone.length-1];e(E.scope,k,t,H,x,G,D)}else q(function(a,d){E.scope=d;var f=l.cloneNode(!1);a[a.length++]=f;c.enter(a,
null,C(v));v=f;E.clone=a;B[E.id]=E;e(E.scope,k,t,H,x,G,D)});r=B})}}}}],xe=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,function(c){a[c?"removeClass":"addClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],qe=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngHide,function(c){a[c?"addClass":"removeClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],ye=Ia(function(a,c,d){a.$watchCollection(d.ngStyle,
function(a,d){d&&a!==d&&m(d,function(a,d){c.css(d,"")});a&&c.css(a)})}),ze=["$animate",function(a){return{require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,f){var g=[],h=[],l=[],k=[],q=function(a,c){return function(){a.splice(c,1)}};c.$watch(e.ngSwitch||e.on,function(c){var d,e;d=0;for(e=l.length;d<e;++d)a.cancel(l[d]);d=l.length=0;for(e=k.length;d<e;++d){var t=lb(h[d].clone);k[d].$destroy();(l[d]=a.leave(t)).then(q(l,d))}h.length=0;k.length=0;(g=f.cases["!"+c]||
f.cases["?"])&&m(g,function(c){c.transclude(function(d,e){k.push(e);var f=c.element;d[d.length++]=W.createComment(" end ngSwitchWhen: ");h.push({clone:d});a.enter(d,f.parent(),f)})})})}}}],Ae=Ia({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[];e.cases["!"+d.ngSwitchWhen].push({transclude:f,element:c})}}),Be=Ia({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,
c,d,e,f){e.cases["?"]=e.cases["?"]||[];e.cases["?"].push({transclude:f,element:c})}}),De=Ia({restrict:"EAC",link:function(a,c,d,e,f){if(!f)throw E("ngTransclude")("orphan",va(c));f(function(a){c.empty();c.append(a)})}}),de=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,c[0].text)}}}],ng={$setViewValue:B,$render:B},og=["$element","$scope","$attrs",function(a,c,d){var e=this,f=new xb;e.ngModelCtrl=ng;e.unknownOption=C(W.createElement("option"));
...
!0)):x(c)&&e.emptyOption?(e.removeUnknownOption(),a.val("")):e.renderUnknownOption(c)};e.addOption=function(a){La(a,'"option value"');var c=f.get(a)||0;f.put(a,c+1)};e.removeOption=function(a){var c=f.get(a);c&&(1===c?f.remove(a):f.put(a,c-1))};e.hasOption=function(a){return!!f.get(a)}}],ee=function(){var a;return{restrict:"E",require:["select","?ngModel"],controller:og,link:function(c,d,e,f){var g=f[1];if(g){var h=f[0];h.ngModelCtrl=g;g.$render=function(){h.writeValue(g.$viewValue)};d.on("change",
function(){c.$apply(function(){g.$setViewValue(h.readValue())})});e.multiple&&(h.readValue=function(){var a=[];m(d.find("option"),function(c){c.selected&&a.push(c.value)});return a},h.writeValue=function(a){var c=new xb(a);m(d.find("option"),function(a){a.selected=A(c.get(a.value))})},c.$watch(function(){ja(a,g.$viewValue)||(a=fa(g.$viewValue),g.$render())}),g.$isEmpty=function(a){return!a||0===a.length})}}}},ge=["$interpolate",function(a){function c(a){a[0].hasAttribute("selected")&&(a[0].selected=
!0)}return{restrict:"E",priority:100,compile:function(d,e){if(x(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),m=k.data("$selectController")||k.parent().data("$selectController");m&&m.ngModelCtrl&&(f?a.$watch(f,function(a,f){e.$set("value",a);f!==a&&m.removeOption(f);m.addOption(a,d);m.ngModelCtrl.$render();c(d)}):(m.addOption(e.value,d),m.ngModelCtrl.$render(),c(d)),d.on("$destroy",function(){m.removeOption(e.value);m.ngModelCtrl.$render()}))}}}}],
fe=qa({restrict:"E",terminal:!1}),Cc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){e&&(d.required=!0,e.$validators.required=function(a,c){return!d.required||!e.$isEmpty(c)},d.$observe("required",function(){e.$validate()}))}}},Bc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f,g=d.ngPattern||d.pattern;d.$observe("pattern",function(a){I(a)&&0<a.length&&(a=new RegExp("^"+a+"$"));if(a&&!a.test)throw E("ngPattern")("noregexp",g,a,va(c));f=
...
function(a,c){return e.$isEmpty(c)||c.length>=f}}}}};P.angular.bootstrap?console.log("WARNING: Tried to load angular more than once."):(Wd(),Yd(ba),C(W).ready(function(){Sd(W,vc)}))})(window,document);!window.angular.$$csp()&&window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>');
...
(function() {
  ...
  nrtc = angular.module('NRTC', ['parse-angular', 'angularMoment', 'ui.bootstrap']).config(function() {
    return Parse.initialize("2Wmev3bHSMdsvl7vfJKVWSl9VcMvg5dU1uGVBeMO", "g7N28dVW3zroZBa8tjEpfNQQtRNyMVym0PeEVEr4");
...
(function() {
  ...
  nrtc.controller("nrtcController", function($scope) {
    $scope.data = {};
    $scope.$on("historyLoaded", function(e, data) {
      return $scope.data.history = data;
    });
    return $scope.$on("activeUsersLoaded", function(e, data) {
      return $scope.data.activeUsers = data.filter(function(item) {
...
(function() {
  ...
  nrtc.controller("nrtcTableController", function($scope) {
...
(function() {
  ...
  nrtc.directive('nrtcTable', function() {
    var directive;
    return directive = {
      replace: true,
      restrict: 'EA',
...
(function() {
  ...
  nrtc.factory("dataService", function($rootScope) {
    var exports, getActiveUsers, getHistory;
    ...
    getActiveUsers = function() {
      ...
      return query.find({
        success: function(data) {
          return $rootScope.$broadcast('activeUsersLoaded', data.map(function(item) {
            return {
              date: item.updatedAt,
              code: item.get('code'),
...
(function() {
    'use strict';
    angular.module('NRTC').run(function($templateCache) {$templateCache.put("scripts/nrtc/template.html","<div class=\"row\"><div class=\"col-md-8 col-md-offset-2\"><h1>Time Control</h1><tabset><tab heading=\"Current Users\"><h2>Current Users</h2><nrtc-table ng-model=\"data.activeUsers\"></nrtc-table></tab><tab heading=\"History\"><h2>History (last 25)</h2><nrtc-table ng-model=\"data.history\"></nrtc-table></tab></tabset></div></div>");
$templateCache.put("scripts/nrtc-table/template.html","<div class=\"row\"><div class=\"col-md-12\"><table class=\"table table-striped table-bordered table-hover table-condensed\"><thead><th>Time</th><th>Code</th></thead><tbody><tr ng-repeat=\"card in model | orderBy:\'date\':true\"><td>{{card.date | amDateFormat:\'HH:mm:ss (dddd, MMMM Do YYYY)\'}}</td><td>{{card.code}}</td></tr></tbody></table></div></div>");})}).call(this);