...
1),!0)}function $(b){return parseInt(b,10)}function Mb(b,a){return O(Object.create(b),a)}function B(){}function Sa(b){return b}function qa(b){return function(){return b}}function x(b){return"undefined"===typeof b}function A(b){return"undefined"!==typeof b}function H(b){return null!==b&&"object"===typeof b}function J(b){return"string"===typeof b}function R(b){return"number"===typeof b}function da(b){return"[object Date]"===sa.call(b)}function G(b){return"function"===typeof b}function Ta(b){return"[object RegExp]"===
sa.call(b)}function Ra(b){return b&&b.window===b}function Ua(b){return b&&b.$evalAsync&&b.$watch}function Va(b){return"boolean"===typeof b}function nc(b){return!(!b||!(b.nodeName||b.prop&&b.attr&&b.find))}function Pd(b){var a={};b=b.split(",");var c;for(c=0;c<b.length;c++)a[b[c]]=!0;return a}function ta(b){return K(b.nodeName||b[0]&&b[0].nodeName)}function Wa(b,a){var c=b.indexOf(a);0<=c&&b.splice(c,1);return c}function ua(b,a,c,d){if(Ra(b)||Ua(b))throw Da("cpws");if(oc.test(sa.call(a)))throw Da("cpta");
if(a){if(b===a)throw Da("cpi");c=c||[];d=d||[];if(H(b)){var e=c.indexOf(b);if(-1!==e)return d[e];c.push(b);d.push(a)}if(F(b))for(var f=a.length=0;f<b.length;f++)e=ua(b[f],null,c,d),H(b[f])&&(c.push(b[f]),d.push(e)),a.push(e);else{var g=a.$$hashKey;F(a)?a.length=0:m(a,function(b,c){delete a[c]});for(f in b)b.hasOwnProperty(f)&&(e=ua(b[f],null,c,d),H(b[f])&&(c.push(b[f]),d.push(e)),a[f]=e);mc(a,g)}}else if(a=b)F(b)?a=ua(b,[],c,d):oc.test(sa.call(b))?a=new b.constructor(b):da(b)?a=new Date(b.getTime()):
Ta(b)?(a=new RegExp(b.source,b.toString().match(/[^\/]*$/)[0]),a.lastIndex=b.lastIndex):H(b)&&(e=Object.create(Object.getPrototypeOf(b)),a=ua(b,e,c,d));return a}function ea(b,a){if(F(b)){a=a||[];for(var c=0,d=b.length;c<d;c++)a[c]=b[c]}else if(H(b))for(c in a=a||{},b)if("$"!==c.charAt(0)||"$"!==c.charAt(1))a[c]=b[c];return a||b}function ka(b,a){if(b===a)return!0;if(null===b||null===a)return!1;if(b!==b&&a!==a)return!0;var c=typeof b,d;if(c==typeof a&&"object"==c)if(F(b)){if(!F(a))return!1;if((c=b.length)==
a.length){for(d=0;d<c;d++)if(!ka(b[d],a[d]))return!1;return!0}}else{if(da(b))return da(a)?ka(b.getTime(),a.getTime()):!1;if(Ta(b))return Ta(a)?b.toString()==a.toString():!1;if(Ua(b)||Ua(a)||Ra(b)||Ra(a)||F(a)||da(a)||Ta(a))return!1;c={};for(d in b)if("$"!==d.charAt(0)&&!G(b[d])){if(!ka(b[d],a[d]))return!1;c[d]=!0}for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==u&&!G(a[d]))return!1;return!0}return!1}function Xa(b,a,c){return b.concat(ra.call(a,c))}function pc(b,a){var c=2<arguments.length?
ra.call(arguments,2):[];return!G(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,Xa(c,arguments,0)):a.apply(b,c)}:function(){return arguments.length?a.apply(b,arguments):a.call(b)}}function Qd(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)&&"$"===b.charAt(1)?c=u:Ra(a)?c="$WINDOW":a&&W===a?c="$DOCUMENT":Ua(a)&&(c="$SCOPE");return c}function Ya(b,a){if("undefined"===typeof b)return u;R(a)||(a=a?2:null);return JSON.stringify(b,Qd,a)}function qc(b){return J(b)?JSON.parse(b):
b}function rc(b,a){var c=Date.parse("Jan 01, 1970 00:00:00 "+b)/6E4;return isNaN(c)?a:c}function Nb(b,a,c){c=c?-1:1;var d=rc(a,b.getTimezoneOffset());a=b;b=c*(d-b.getTimezoneOffset());a=new Date(a.getTime());a.setMinutes(a.getMinutes()+b);return a}function va(b){b=C(b).clone();try{b.empty()}catch(a){}var c=C("<div>").append(b).html();try{return b[0].nodeType===Za?K(c):c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,function(a,b){return"<"+K(b)})}catch(d){return K(c)}}function sc(b){try{return decodeURIComponent(b)}catch(a){}}
function tc(b){var a={},c,d;m((b||"").split("&"),function(b){b&&(c=b.replace(/\+/g,"%20").split("="),d=sc(c[0]),A(d)&&(b=A(c[1])?sc(c[1]):!0,uc.call(a,d)?F(a[d])?a[d].push(b):a[d]=[a[d],b]:a[d]=b))});return a}function Ob(b){var a=[];m(b,function(b,d){F(b)?m(b,function(b){a.push(Ea(d,!0)+(!0===b?"":"="+Ea(b,!0)))}):a.push(Ea(d,!0)+(!0===b?"":"="+Ea(b,!0)))});return a.length?a.join("&"):""}function jb(b){return Ea(b,!0).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+")}function Ea(b,a){return encodeURIComponent(b).replace(/%40/gi,
"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%3B/gi,";").replace(/%20/g,a?"%20":"+")}function Rd(b,a){var c,d,e=Ka.length;for(d=0;d<e;++d)if(c=Ka[d]+a,J(c=b.getAttribute(c)))return c;return null}function Sd(b,a){var c,d,e={};m(Ka,function(a){a+="app";!c&&b.hasAttribute&&b.hasAttribute(a)&&(c=b,d=b.getAttribute(a))});m(Ka,function(a){a+="app";var e;!c&&(e=b.querySelector("["+a.replace(":","\\:")+"]"))&&(c=e,d=e.getAttribute(a))});c&&(e.strictDi=null!==Rd(c,"strict-di"),
a(c,d?[d]:[],e))}function vc(b,a,c){H(c)||(c={});c=O({strictDi:!1},c);var d=function(){b=C(b);if(b.injector()){var d=b[0]===W?"document":va(b);throw Da("btstrpd",d.replace(/</,"&lt;").replace(/>/,"&gt;"));}a=a||[];a.unshift(["$provide",function(a){a.value("$rootElement",b)}]);c.debugInfoEnabled&&a.push(["$compileProvider",function(a){a.debugInfoEnabled(!0)}]);a.unshift("ng");d=$a(a,c.strictDi);d.invoke(["$rootScope","$rootElement","$compile","$injector",function(a,b,c,d){a.$apply(function(){b.data("$injector",
d);c(b)(a)})}]);return d},e=/^NG_ENABLE_DEBUG_INFO!/,f=/^NG_DEFER_BOOTSTRAP!/;P&&e.test(P.name)&&(c.debugInfoEnabled=!0,P.name=P.name.replace(e,""));if(P&&!f.test(P.name))return d();P.name=P.name.replace(f,"");aa.resumeBootstrap=function(b){m(b,function(b){a.push(b)});return d()};G(aa.resumeDeferredBootstrap)&&aa.resumeDeferredBootstrap()}function Td(){P.name="NG_ENABLE_DEBUG_INFO!"+P.name;P.location.reload()}function Ud(b){b=aa.element(b).injector();if(!b)throw Da("test");return b.get("$$testability")}
...
C;xc=!0}}function Qb(b,a,c){if(!b)throw Da("areq",a||"?",c||"required");return b}function lb(b,a,c){c&&F(b)&&(b=b[b.length-1]);Qb(G(b),a,"not a function, got "+(b&&"object"===typeof b?b.constructor.name||"Object":typeof b));return b}function Ma(b,a){if("hasOwnProperty"===b)throw Da("badname",a);}function yc(b,a,c){if(!a)return b;a=a.split(".");for(var d,e=b,f=a.length,g=0;g<f;g++)d=a[g],b&&(b=(e=b)[d]);return!c&&G(b)?pc(e,b):b}function mb(b){var a=b[0];b=b[b.length-1];var c=[a];do{a=a.nextSibling;
if(!a)break;c.push(a)}while(a!==b);return C(c)}function ma(){return Object.create(null)}function Xd(b){function a(a,b,c){return a[b]||(a[b]=c())}var c=E("$injector"),d=E("ng");b=a(b,"angular",Object);b.$$minErr=b.$$minErr||E;return a(b,"module",function(){var b={};return function(f,g,h){if("hasOwnProperty"===f)throw d("badname","module");g&&b.hasOwnProperty(f)&&(b[f]=null);return a(b,f,function(){function a(c,d,e,f){f||(f=b);return function(){f[e||"push"]([c,d,arguments]);return r}}if(!g)throw c("nomod",
...
config:s,run:function(a){e.push(a);return this}};h&&s(h);return r})}})}function Yd(b){O(b,{bootstrap:vc,copy:ua,extend:O,merge:Od,equals:ka,element:C,forEach:m,injector:$a,noop:B,bind:pc,toJson:Ya,fromJson:qc,identity:Sa,isUndefined:x,isDefined:A,isString:J,isFunction:G,isObject:H,isNumber:R,isElement:nc,isArray:F,version:Zd,isDate:da,lowercase:K,uppercase:nb,callbacks:{counter:0},getTestability:Ud,$$minErr:E,$$csp:ab,reloadWithDebugInfo:Td});bb=Xd(P);try{bb("ngLocale")}catch(a){bb("ngLocale",[]).provider("$locale",
$d)}bb("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:ae});a.provider("$compile",zc).directive({a:be,input:Ac,textarea:Ac,form:ce,script:de,select:ee,style:fe,option:ge,ngBind:he,ngBindHtml:ie,ngBindTemplate:je,ngClass:ke,ngClassEven:le,ngClassOdd:me,ngCloak:ne,ngController:oe,ngForm:pe,ngHide:qe,ngIf:re,ngInclude:se,ngInit:te,ngNonBindable:ue,ngPluralize:ve,ngRepeat:we,ngShow:xe,ngStyle:ye,ngSwitch:ze,ngSwitchWhen:Ae,ngSwitchDefault:Be,ngOptions:Ce,ngTransclude:De,ngModel:Ee,
ngList:Fe,ngChange:Ge,pattern:Bc,ngPattern:Bc,required:Cc,ngRequired:Cc,minlength:Dc,ngMinlength:Dc,maxlength:Ec,ngMaxlength:Ec,ngValue:He,ngModelOptions:Ie}).directive({ngInclude:Je}).directive(ob).directive(Fc);a.provider({$anchorScroll:Ke,$animate:Le,$browser:Me,$cacheFactory:Ne,$controller:Oe,$document:Pe,$exceptionHandler:Qe,$filter:Gc,$interpolate:Re,$interval:Se,$http:Te,$httpBackend:Ue,$location:Ve,$log:We,$parse:Xe,$rootScope:Ye,$q:Ze,$$q:$e,$sce:af,$sceDelegate:bf,$sniffer:cf,$templateCache:df,
$templateRequest:ef,$$testability:ff,$timeout:gf,$window:hf,$$rAF:jf,$$asyncCallback:kf,$$jqLite:lf,$$HashMap:mf,$$cookieReader:nf})}])}function cb(b){return b.replace(of,function(a,b,d,e){return e?d.toUpperCase():d}).replace(pf,"Moz$1")}function Hc(b){b=b.nodeType;return b===pa||!b||9===b}function Ic(b,a){var c,d,e=a.createDocumentFragment(),f=[];if(Rb.test(b)){c=c||e.appendChild(a.createElement("div"));d=(qf.exec(b)||["",""])[1].toLowerCase();d=fa[d]||fa._default;c.innerHTML=d[1]+b.replace(rf,"<$1></$2>")+
d[2];for(d=d[0];d--;)c=c.lastChild;f=Xa(f,c.childNodes);c=e.firstChild;c.textContent=""}else f.push(a.createTextNode(b));e.textContent="";e.innerHTML="";m(f,function(a){e.appendChild(a)});return e}function S(b){if(b instanceof S)return b;var a;J(b)&&(b=T(b),a=!0);if(!(this instanceof S)){if(a&&"<"!=b.charAt(0))throw Sb("nosel");return new S(b)}if(a){a=W;var c;b=(c=sf.exec(b))?[a.createElement(c[1])]:(c=Ic(b,a))?c.childNodes:[]}Jc(this,b)}function Tb(b){return b.cloneNode(!0)}function pb(b,a){a||qb(b);
if(b.querySelectorAll)for(var c=b.querySelectorAll("*"),d=0,e=c.length;d<e;d++)qb(c[d])}function Kc(b,a,c,d){if(A(d))throw Sb("offargs");var e=(d=rb(b))&&d.events,f=d&&d.handle;if(f)if(a)m(a.split(" "),function(a){if(A(c)){var d=e[a];Wa(d||[],c);if(d&&0<d.length)return}b.removeEventListener(a,f,!1);delete e[a]});else for(a in e)"$destroy"!==a&&b.removeEventListener(a,f,!1),delete e[a]}function qb(b,a){var c=b.ng339,d=c&&sb[c];d&&(a?delete d.data[a]:(d.handle&&(d.events.$destroy&&d.handle({},"$destroy"),
Kc(b)),delete sb[c],b.ng339=u))}function rb(b,a){var c=b.ng339,c=c&&sb[c];a&&!c&&(b.ng339=c=++tf,c=sb[c]={events:{},data:{},handle:u});return c}function Ub(b,a,c){if(Hc(b)){var d=A(c),e=!d&&a&&!H(a),f=!a;b=(b=rb(b,!e))&&b.data;if(d)b[a]=c;else{if(f)return b;if(e)return b&&b[a];O(b,a)}}}function tb(b,a){return b.getAttribute?-1<(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").indexOf(" "+a+" "):!1}function ub(b,a){a&&b.setAttribute&&m(a.split(" "),function(a){b.setAttribute("class",T((" "+
(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").replace(" "+T(a)+" "," ")))})}function vb(b,a){if(a&&b.setAttribute){var c=(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ");m(a.split(" "),function(a){a=T(a);-1===c.indexOf(" "+a+" ")&&(c+=a+" ")});b.setAttribute("class",T(c))}}function Jc(b,a){if(a)if(a.nodeType)b[b.length++]=a;else{var c=a.length;if("number"===typeof c&&a.window!==a){if(c)for(var d=0;d<c;d++)b[b.length++]=a[d]}else b[b.length++]=a}}function Lc(b,a){return wb(b,
"$"+(a||"ngController")+"Controller")}function wb(b,a,c){9==b.nodeType&&(b=b.documentElement);for(a=F(a)?a:[a];b;){for(var d=0,e=a.length;d<e;d++)if((c=C.data(b,a[d]))!==u)return c;b=b.parentNode||11===b.nodeType&&b.host}}function Mc(b){for(pb(b,!0);b.firstChild;)b.removeChild(b.firstChild)}function Vb(b,a){a||pb(b);var c=b.parentNode;c&&c.removeChild(b)}function uf(b,a){a=a||P;if("complete"===a.document.readyState)a.setTimeout(b);else C(a).on("load",b)}function Nc(b,a){var c=xb[a.toLowerCase()];
return c&&Oc[ta(b)]&&c}function vf(b,a){var c=b.nodeName;return("INPUT"===c||"TEXTAREA"===c)&&Pc[a]}function wf(b,a){var c=function(c,e){c.isDefaultPrevented=function(){return c.defaultPrevented};var f=a[e||c.type],g=f?f.length:0;if(g){if(x(c.immediatePropagationStopped)){var h=c.stopImmediatePropagation;c.stopImmediatePropagation=function(){c.immediatePropagationStopped=!0;c.stopPropagation&&c.stopPropagation();h&&h.call(c)}}c.isImmediatePropagationStopped=function(){return!0===c.immediatePropagationStopped};
1<g&&(f=ea(f));for(var l=0;l<g;l++)c.isImmediatePropagationStopped()||f[l].call(b,c)}};c.elem=b;return c}function lf(){this.$get=function(){return O(S,{hasClass:function(b,a){b.attr&&(b=b[0]);return tb(b,a)},addClass:function(b,a){b.attr&&(b=b[0]);return vb(b,a)},removeClass:function(b,a){b.attr&&(b=b[0]);return ub(b,a)}})}}function Fa(b,a){var c=b&&b.$$hashKey;if(c)return"function"===typeof c&&(c=b.$$hashKey()),c;c=typeof b;return c="function"==c||"object"==c&&null!==b?b.$$hashKey=c+":"+(a||Nd)():
c+":"+b}function db(b,a){if(a){var c=0;this.nextUid=function(){return++c}}m(b,this.put,this)}function xf(b){return(b=b.toString().replace(Qc,"").match(Rc))?"function("+(b[1]||"").replace(/[\s\r\n]+/," ")+")":"fn"}function $a(b,a){function c(a){return function(b,c){if(H(b))m(b,lc(a));else return a(b,c)}}function d(a,b){Ma(a,"service");if(G(b)||F(b))b=s.instantiate(b);if(!b.$get)throw Ga("pget",a);return n[a+"Provider"]=b}function e(a,b){return function(){var c=y.invoke(b,this);if(x(c))throw Ga("undef",
a);return c}}function f(a,b,c){return d(a,{$get:!1!==c?e(a,b):b})}function g(a){var b=[],c;m(a,function(a){function d(a){var b,c;b=0;for(c=a.length;b<c;b++){var e=a[b],f=s.get(e[0]);f[e[1]].apply(f,e[2])}}if(!q.get(a)){q.put(a,!0);try{J(a)?(c=bb(a),b=b.concat(g(c.requires)).concat(c._runBlocks),d(c._invokeQueue),d(c._configBlocks)):G(a)?b.push(s.invoke(a)):F(a)?b.push(s.invoke(a)):lb(a,"module")}catch(e){throw F(a)&&(a=a[a.length-1]),e.message&&e.stack&&-1==e.stack.indexOf(e.message)&&(e=e.message+
"\n"+e.stack),Ga("modulerr",a,e.stack||e.message||e);}}});return b}function h(b,c){function d(a,e){if(b.hasOwnProperty(a)){if(b[a]===l)throw Ga("cdep",a+" <- "+k.join(" <- "));return b[a]}try{return k.unshift(a),b[a]=l,b[a]=c(a,e)}catch(f){throw b[a]===l&&delete b[a],f;}finally{k.shift()}}function e(b,c,f,g){"string"===typeof f&&(g=f,f=null);var k=[],h=$a.$$annotate(b,a,g),l,s,n;s=0;for(l=h.length;s<l;s++){n=h[s];if("string"!==typeof n)throw Ga("itkn",n);k.push(f&&f.hasOwnProperty(n)?f[n]:d(n,g))}F(b)&&
(b=b[l]);return b.apply(c,k)}return{invoke:e,instantiate:function(a,b,c){var d=Object.create((F(a)?a[a.length-1]:a).prototype||null);a=e(a,d,b,c);return H(a)||G(a)?a:d},get:d,annotate:$a.$$annotate,has:function(a){return n.hasOwnProperty(a+"Provider")||b.hasOwnProperty(a)}}}a=!0===a;var l={},k=[],q=new db([],!0),n={$provide:{provider:c(d),factory:c(f),service:c(function(a,b){return f(a,["$injector",function(a){return a.instantiate(b)}])}),value:c(function(a,b){return f(a,qa(b),!1)}),constant:c(function(a,
b){Ma(a,"constant");n[a]=b;r[a]=b}),decorator:function(a,b){var c=s.get(a+"Provider"),d=c.$get;c.$get=function(){var a=y.invoke(d,c);return y.invoke(b,null,{$delegate:a})}}}},s=n.$injector=h(n,function(a,b){aa.isString(b)&&k.push(b);throw Ga("unpr",k.join(" <- "));}),r={},y=r.$injector=h(r,function(a,b){var c=s.get(a+"Provider",b);return y.invoke(c.$get,c,u,a)});m(g(b),function(a){y.invoke(a||B)});return y}function Ke(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location",
"$rootScope",function(a,c,d){function e(a){var b=null;Array.prototype.some.call(a,function(a){if("a"===ta(a))return b=a,!0});return b}function f(b){if(b){b.scrollIntoView();var c;c=g.yOffset;G(c)?c=c():nc(c)?(c=c[0],c="fixed"!==a.getComputedStyle(c).position?0:c.getBoundingClientRect().bottom):R(c)||(c=0);c&&(b=b.getBoundingClientRect().top,a.scrollBy(0,b-c))}else a.scrollTo(0,0)}function g(){var a=c.hash(),b;a?(b=h.getElementById(a))?f(b):(b=e(h.getElementsByName(a)))?f(b):"top"===a&&f(null):f(null)}
var h=a.document;b&&d.$watch(function(){return c.hash()},function(a,b){a===b&&""===a||uf(function(){d.$evalAsync(g)})});return g}]}function kf(){this.$get=["$$rAF","$timeout",function(b,a){return b.supported?function(a){return b(a)}:function(b){return a(b,0,!1)}}]}function yf(b,a,c,d){function e(a){try{a.apply(null,ra.call(arguments,1))}finally{if(y--,0===y)for(;N.length;)try{N.pop()()}catch(b){c.error(b)}}}function f(){g();h()}function g(){a:{try{v=q.state;break a}catch(a){}v=void 0}v=x(v)?null:
v;ka(v,D)&&(v=D);D=v}function h(){if(w!==l.url()||p!==v)w=l.url(),p=v,m(M,function(a){a(l.url(),v)})}var l=this,k=b.location,q=b.history,n=b.setTimeout,s=b.clearTimeout,r={};l.isMock=!1;var y=0,N=[];l.$$completeOutstandingRequest=e;l.$$incOutstandingRequestCount=function(){y++};l.notifyWhenNoOutstandingRequests=function(a){0===y?a():N.push(a)};var v,p,w=k.href,ga=a.find("base"),z=null;g();p=v;l.url=function(a,c,e){x(e)&&(e=null);k!==b.location&&(k=b.location);q!==b.history&&(q=b.history);if(a){var f=
p===e;if(w===a&&(!d.history||f))return l;var h=w&&Ha(w)===Ha(a);w=a;p=e;!d.history||h&&f?(h||(z=a),c?k.replace(a):h?(c=k,e=a.indexOf("#"),a=-1===e?"":a.substr(e+1),c.hash=a):k.href=a):(q[c?"replaceState":"pushState"](e,"",a),g(),p=v);return l}return z||k.href.replace(/%27/g,"'")};l.state=function(){return v};var M=[],L=!1,D=null;l.onUrlChange=function(a){if(!L){if(d.history)C(b).on("popstate",f);C(b).on("hashchange",f);L=!0}M.push(a);return a};l.$$checkUrlChange=h;l.baseHref=function(){var a=ga.attr("href");
return a?a.replace(/^(https?\:)?\/\/[^\/]*/,""):""};l.defer=function(a,b){var c;y++;c=n(function(){delete r[c];e(a)},b||0);r[c]=!0;return c};l.defer.cancel=function(a){return r[a]?(delete r[a],s(a),e(B),!0):!1}}function Me(){this.$get=["$window","$log","$sniffer","$document",function(b,a,c,d){return new yf(b,d,a,c)}]}function Ne(){this.$get=function(){function b(b,d){function e(a){a!=n&&(s?s==a&&(s=a.n):s=a,f(a.n,a.p),f(a,n),n=a,n.n=null)}function f(a,b){a!=b&&(a&&(a.p=b),b&&(b.n=a))}if(b in a)throw E("$cacheFactory")("iid",
b);var g=0,h=O({},d,{id:b}),l={},k=d&&d.capacity||Number.MAX_VALUE,q={},n=null,s=null;return a[b]={put:function(a,b){if(!x(b)){if(k<Number.MAX_VALUE){var c=q[a]||(q[a]={key:a});e(c)}a in l||g++;l[a]=b;g>k&&this.remove(s.key);return b}},get:function(a){if(k<Number.MAX_VALUE){var b=q[a];if(!b)return;e(b)}return l[a]},remove:function(a){if(k<Number.MAX_VALUE){var b=q[a];if(!b)return;b==n&&(n=b.p);b==s&&(s=b.n);f(b.n,b.p);delete q[a]}delete l[a];g--},removeAll:function(){l={};g=0;q={};n=s=null},destroy:function(){q=
h=l=null;delete a[b]},info:function(){return O({},h,{size:g})}}}var a={};b.info=function(){var b={};m(a,function(a,e){b[e]=a.info()});return b};b.get=function(b){return a[b]};return b}}function df(){this.$get=["$cacheFactory",function(b){return b("templates")}]}function zc(b,a){function c(a,b,c){var d=/^\s*([@&]|=(\*?))(\??)\s*(\w*)\s*$/,e={};m(a,function(a,f){var g=a.match(d);if(!g)throw ha("iscp",b,f,a,c?"controller bindings definition":"isolate scope definition");e[f]={mode:g[1][0],collection:"*"===
g[2],optional:"?"===g[3],attrName:g[4]||f}});return e}var d={},e=/^\s*directive\:\s*([\w\-]+)\s+(.*)$/,f=/(([\w\-]+)(?:\:([^;]+))?;?)/,g=Pd("ngSrc,ngSrcset,src,srcset"),h=/^(?:(\^\^?)?(\?)?(\^\^?)?)?/,l=/^(on[a-z]+|formaction)$/;this.directive=function n(a,e){Ma(a,"directive");J(a)?(Qb(e,"directiveFactory"),d.hasOwnProperty(a)||(d[a]=[],b.factory(a+"Directive",["$injector","$exceptionHandler",function(b,e){var f=[];m(d[a],function(d,g){try{var h=b.invoke(d);G(h)?h={compile:qa(h)}:!h.compile&&h.link&&
...
a:if(Q&&J(Q))ba=Q;else{if(J(X)){var m=Sc.exec(X);if(m){ba=m[3];break a}}ba=void 0}if(!ba)throw ha("noident",n);}var na=k.$$bindings=r;H(na.isolateScope)&&(h.$$isolateBindings=na.isolateScope);f.push(h)}catch(t){e(t)}});return f}])),d[a].push(e)):m(a,lc(n));return this};this.aHrefSanitizationWhitelist=function(b){return A(b)?(a.aHrefSanitizationWhitelist(b),this):a.aHrefSanitizationWhitelist()};this.imgSrcSanitizationWhitelist=function(b){return A(b)?(a.imgSrcSanitizationWhitelist(b),this):a.imgSrcSanitizationWhitelist()};
var k=!0;this.debugInfoEnabled=function(a){return A(a)?(k=a,this):k};this.$get=["$injector","$interpolate","$exceptionHandler","$templateRequest","$parse","$controller","$rootScope","$document","$sce","$animate","$$sanitizeUri",function(a,b,c,y,N,v,p,w,ga,z,M){function L(a,b){try{a.addClass(b)}catch(c){}}function D(a,b,c,d,e){a instanceof C||(a=C(a));m(a,function(b,c){b.nodeType==Za&&b.nodeValue.match(/\S+/)&&(a[c]=C(b).wrap("<span></span>").parent()[0])});var f=X(a,b,a,c,d,e);D.$$addScopeClass(a);
var h=null;return function(b,c,d){Qb(b,"scope");d=d||{};var e=d.parentBoundTranscludeFn,g=d.transcludeControllers;d=d.futureParentElement;e&&e.$$boundTransclude&&(e=e.$$boundTransclude);h||(h=(d=d&&d[0])?"foreignobject"!==ta(d)&&d.toString().match(/SVG/)?"svg":"html":"html");d="html"!==h?C(Wb(h,C("<div>").append(a).html())):c?La.clone.call(a):a;if(g)for(var k in g)d.data("$"+k+"Controller",g[k].instance);D.$$addScopeInfo(d,b);c&&c(d,b);f&&f(b,d,d,e);return d}}function X(a,b,c,d,e,f){function h(a,
...
c,d,h){var g=c.$attr,k;switch(a.nodeType){case pa:x(b,xa(ta(a)),"E",d,h);for(var l,s,n,p=a.attributes,r=0,M=p&&p.length;r<M;r++){var y=!1,D=!1;l=p[r];k=l.name;s=T(l.value);l=xa(k);if(n=ja.test(l))k=k.replace(Tc,"").substr(8).replace(/_(.)/g,function(a,b){return b.toUpperCase()});var L=l.replace(/(Start|End)$/,"");E(L)&&l===L+"Start"&&(y=k,D=k.substr(0,k.length-5)+"end",k=k.substr(0,k.length-6));l=xa(k.toLowerCase());g[l]=k;if(n||!c.hasOwnProperty(l))c[l]=s,Nc(a,l)&&(c[l]=!0);V(a,b,s,l,n);x(b,l,"A",
d,h,y,D)}a=a.className;H(a)&&(a=a.animVal);if(J(a)&&""!==a)for(;k=f.exec(a);)l=xa(k[2]),x(b,l,"C",d,h)&&(c[l]=T(k[3])),a=a.substr(k.index+k[0].length);break;case Za:R(b,a.nodeValue);break;case 8:try{if(k=e.exec(a.nodeValue))l=xa(k[1]),x(b,l,"M",d,h)&&(c[l]=T(k[2]))}catch(N){}}b.sort(za);return b}function wa(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ha("uterdir",b,c);a.nodeType==pa&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&e--);d.push(a);a=a.nextSibling}while(0<
e)}else d.push(a);return C(d)}function na(a,b,c){return function(d,e,f,h,g){e=wa(e[0],b,c);return a(d,e,f,h,g)}}function t(a,b,d,e,f,g,k,l,s){function n(a,b,c,d){if(a){c&&(a=na(a,c,d));a.require=I.require;a.directiveName=B;if(w===I||I.$$isolateScope)a=Z(a,{isolateScope:!0});k.push(a)}if(b){c&&(b=na(b,c,d));b.require=I.require;b.directiveName=B;if(w===I||I.$$isolateScope)b=Z(b,{isolateScope:!0});l.push(b)}}function p(a,b,c,d){var e;if(J(b)){var f=b.match(h);b=b.substring(f[0].length);var g=f[1]||f[3],
f="?"===f[2];"^^"===g?c=c.parent():e=(e=d&&d[b])&&e.instance;e||(d="$"+b+"Controller",e=g?c.inheritedData(d):c.data(d));if(!e&&!f)throw ha("ctreq",b,a);}else if(F(b))for(e=[],g=0,f=b.length;g<f;g++)e[g]=p(a,b[g],c,d);return e||null}function M(a,b,c,d,e,f){var g=ma(),h;for(h in d){var k=d[h],l={$scope:k===w||k.$$isolateScope?e:f,$element:a,$attrs:b,$transclude:c},s=k.controller;"@"==s&&(s=b[k.name]);l=v(s,l,!0,k.controllerAs);g[k.name]=l;Na||a.data("$"+k.name+"Controller",l.instance)}return g}function y(a,
c,e,f,g,h){function s(a,b,c){var d;Ua(a)||(c=b,b=a,a=u);Na&&(d=ba);c||(c=Na?ia.parent():ia);return g(a,b,d,c,ga)}var n,r,L,v,ba,X,ia;b===e?(f=d,ia=d.$$element):(ia=C(e),f=new ca(ia,d));w&&(v=c.$new(!0));g&&(X=s,X.$$boundTransclude=g);Q&&(ba=M(ia,f,X,Q,v,c));w&&(D.$$addScopeInfo(ia,v,!0,!(z&&(z===w||z===w.$$originalDirective))),D.$$addScopeClass(ia,!0),v.$$isolateBindings=w.$$isolateBindings,aa(c,f,v,v.$$isolateBindings,w,v));if(ba){var m=w||N,na;m&&ba[m.name]&&(r=m.$$bindings.bindToController,(L=
ba[m.name])&&L.identifier&&r&&(na=L,h.$$destroyBindings=aa(c,f,L.instance,r,m)));for(n in ba){L=ba[n];var wa=L();wa!==L.instance&&(L.instance=wa,ia.data("$"+I.name+"Controller",wa),L===na&&(h.$$destroyBindings(),h.$$destroyBindings=aa(c,f,wa,r,m)))}}n=0;for(h=k.length;n<h;n++)r=k[n],$(r,r.isolateScope?v:c,ia,f,r.require&&p(r.directiveName,r.require,ia,ba),X);var ga=c;w&&(w.template||null===w.templateUrl)&&(ga=v);a&&a(ga,e.childNodes,u,g);for(n=l.length-1;0<=n;n--)r=l[n],$(r,r.isolateScope?v:c,ia,
f,r.require&&p(r.directiveName,r.require,ia,ba),X)}s=s||{};for(var L=-Number.MAX_VALUE,N,Q=s.controllerDirectives,w=s.newIsolateScopeDirective,z=s.templateDirective,X=s.nonTlbTranscludeDirective,m=!1,ga=!1,Na=s.hasElementTranscludeDirective,x=d.$$element=C(b),I,B,U,E=e,za,K=0,O=a.length;K<O;K++){I=a[K];var yb=I.$$start,R=I.$$end;yb&&(x=wa(b,yb,R));U=u;if(L>I.priority)break;if(U=I.scope)I.templateUrl||(H(U)?(Oa("new/isolated scope",w||N,I,x),w=I):Oa("new/isolated scope",w,I,x)),N=N||I;B=I.name;!I.templateUrl&&
I.controller&&(U=I.controller,Q=Q||ma(),Oa("'"+B+"' controller",Q[B],I,x),Q[B]=I);if(U=I.transclude)m=!0,I.$$tlb||(Oa("transclusion",X,I,x),X=I),"element"==U?(Na=!0,L=I.priority,U=x,x=d.$$element=C(W.createComment(" "+B+": "+d[B]+" ")),b=x[0],Y(f,ra.call(U,0),b),E=D(U,e,L,g&&g.name,{nonTlbTranscludeDirective:X})):(U=C(Tb(b)).contents(),x.empty(),E=D(U,e));if(I.template)if(ga=!0,Oa("template",z,I,x),z=I,U=G(I.template)?I.template(x,d):I.template,U=fa(U),I.replace){g=I;U=Rb.test(U)?Uc(Wb(I.templateNamespace,
T(U))):[];b=U[0];if(1!=U.length||b.nodeType!==pa)throw ha("tplrt",B,"");Y(f,x,b);O={$attr:{}};U=ba(b,[],O);var Xb=a.splice(K+1,a.length-(K+1));w&&A(U);a=a.concat(U).concat(Xb);P(d,O);O=a.length}else x.html(U);if(I.templateUrl)ga=!0,Oa("template",z,I,x),z=I,I.replace&&(g=I),y=S(a.splice(K,a.length-K),x,d,f,m&&E,k,l,{controllerDirectives:Q,newIsolateScopeDirective:w,templateDirective:z,nonTlbTranscludeDirective:X}),O=a.length;else if(I.compile)try{za=I.compile(x,d,E),G(za)?n(null,za,yb,R):za&&n(za.pre,
za.post,yb,R)}catch(V){c(V,va(x))}I.terminal&&(y.terminal=!0,L=Math.max(L,I.priority))}y.scope=N&&!0===N.scope;y.transcludeOnThisElement=m;y.elementTranscludeOnThisElement=Na;y.templateOnThisElement=ga;y.transclude=E;s.hasElementTranscludeDirective=Na;return y}function A(a){for(var b=0,c=a.length;b<c;b++)a[b]=Mb(a[b],{$$isolateScope:!0})}function x(b,e,f,g,h,k,l){if(e===h)return null;h=null;if(d.hasOwnProperty(e)){var s;e=a.get(e+"Directive");for(var p=0,y=e.length;p<y;p++)try{s=e[p],(g===u||g>s.priority)&&
-1!=s.restrict.indexOf(f)&&(k&&(s=Mb(s,{$$start:k,$$end:l})),b.push(s),h=s)}catch(M){c(M)}}return h}function E(b){if(d.hasOwnProperty(b))for(var c=a.get(b+"Directive"),e=0,f=c.length;e<f;e++)if(b=c[e],b.multiElement)return!0;return!1}function P(a,b){var c=b.$attr,d=a.$attr,e=a.$$element;m(a,function(d,e){"$"!=e.charAt(0)&&(b[e]&&b[e]!==d&&(d+=("style"===e?";":" ")+b[e]),a.$set(e,d,!0,c[e]))});m(b,function(b,f){"class"==f?(L(e,b),a["class"]=(a["class"]?a["class"]+" ":"")+b):"style"==f?(e.attr("style",
e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==f.charAt(0)||a.hasOwnProperty(f)||(a[f]=b,d[f]=c[f])})}function S(a,b,c,d,e,f,g,h){var k=[],l,s,n=b[0],p=a.shift(),r=Mb(p,{templateUrl:null,transclude:null,replace:null,$$originalDirective:p}),M=G(p.templateUrl)?p.templateUrl(b,c):p.templateUrl,D=p.templateNamespace;b.empty();y(ga.getTrustedResourceUrl(M)).then(function(y){var N,v;y=fa(y);if(p.replace){y=Rb.test(y)?Uc(Wb(D,T(y))):[];N=y[0];if(1!=y.length||N.nodeType!==pa)throw ha("tplrt",
p.name,M);y={$attr:{}};Y(d,b,N);var w=ba(N,[],y);H(p.scope)&&A(w);a=w.concat(a);P(c,y)}else N=n,b.html(y);a.unshift(r);l=t(a,N,c,e,b,p,f,g,h);m(d,function(a,c){a==N&&(d[c]=b[0])});for(s=X(b[0].childNodes,e);k.length;){y=k.shift();v=k.shift();var z=k.shift(),na=k.shift(),w=b[0];if(!y.$$destroyed){if(v!==n){var wa=v.className;h.hasElementTranscludeDirective&&p.replace||(w=Tb(N));Y(z,C(v),w);L(C(w),wa)}v=l.transcludeOnThisElement?Q(y,l.transclude,na):na;l(s,y,w,d,v,l)}}k=null});return function(a,b,c,
d,e){a=e;b.$$destroyed||(k?k.push(b,c,d,a):(l.transcludeOnThisElement&&(a=Q(b,l.transclude,e)),l(s,b,c,d,a,l)))}}function za(a,b){var c=b.priority-a.priority;return 0!==c?c:a.name!==b.name?a.name<b.name?-1:1:a.index-b.index}function Oa(a,b,c,d){if(b)throw ha("multidir",b.name,c.name,a,va(d));}function R(a,c){var d=b(c,!0);d&&a.push({priority:0,compile:function(a){a=a.parent();var b=!!a.length;b&&D.$$addBindingClass(a);return function(a,c){var e=c.parent();b||D.$$addBindingClass(e);D.$$addBindingInfo(e,
d.expressions);a.$watch(d,function(a){c[0].nodeValue=a})}}})}function Wb(a,b){a=K(a||"html");switch(a){case "svg":case "math":var c=W.createElement("div");c.innerHTML="<"+a+">"+b+"</"+a+">";return c.childNodes[0].childNodes;default:return b}}function Xb(a,b){if("srcdoc"==b)return ga.HTML;var c=ta(a);if("xlinkHref"==b||"form"==c&&"action"==b||"img"!=c&&("src"==b||"ngSrc"==b))return ga.RESOURCE_URL}function V(a,c,d,e,f){var h=Xb(a,e);f=g[e]||f;var k=b(d,!0,h,f);if(k){if("multiple"===e&&"select"===ta(a))throw ha("selmulti",
...
h++)h<k?a[g]=a[h]:delete a[g];a.length-=e-1;a.context===d&&(a.context=c);break}f&&f.replaceChild(c,d);a=W.createDocumentFragment();a.appendChild(d);C(c).data(C(d).data());la?(Pb=!0,la.cleanData([d])):delete C.cache[d[C.expando]];d=1;for(e=b.length;d<e;d++)f=b[d],C(f).remove(),a.appendChild(f),delete b[d];b[0]=c;b.length=1}function Z(a,b){return O(function(){return a.apply(null,arguments)},a,b)}function $(a,b,d,e,f,g){try{a(b,d,e,f,g)}catch(h){c(h,va(d))}}function aa(a,c,d,e,f,g){var h;m(e,function(e,
g){var k=e.attrName,l=e.optional,n,p,r,y;switch(e.mode){case "@":c.$observe(k,function(a){d[g]=a});c.$$observers[k].$$scope=a;c[k]&&(d[g]=b(c[k])(a));break;case "=":if(l&&!c[k])break;p=N(c[k]);y=p.literal?ka:function(a,b){return a===b||a!==a&&b!==b};r=p.assign||function(){n=d[g]=p(a);throw ha("nonassign",c[k],f.name);};n=d[g]=p(a);l=function(b){y(b,d[g])||(y(b,n)?r(a,b=d[g]):d[g]=b);return n=b};l.$stateful=!0;l=e.collection?a.$watchCollection(c[k],l):a.$watch(N(c[k],l),null,p.literal);h=h||[];h.push(l);
break;case "&":if(!c.hasOwnProperty(k)&&l)break;p=N(c[k]);if(p===B&&l)break;d[g]=function(b){return p(a,b)}}});e=h?function(){for(var a=0,b=h.length;a<b;++a)h[a]()}:B;return g&&e!==B?(g.$on("$destroy",e),B):e}var ca=function(a,b){if(b){var c=Object.keys(b),d,e,f;d=0;for(e=c.length;d<e;d++)f=c[d],this[f]=b[f]}else this.$attr={};this.$$element=a};ca.prototype={$normalize:xa,$addClass:function(a){a&&0<a.length&&z.addClass(this.$$element,a)},$removeClass:function(a){a&&0<a.length&&z.removeClass(this.$$element,
a)},$updateClass:function(a,b){var c=Vc(a,b);c&&c.length&&z.addClass(this.$$element,c);(c=Vc(b,a))&&c.length&&z.removeClass(this.$$element,c)},$set:function(a,b,d,e){var f=this.$$element[0],g=Nc(f,a),h=vf(f,a),f=a;g?(this.$$element.prop(a,b),e=g):h&&(this[h]=b,f=h);this[a]=b;e?this.$attr[a]=e:(e=this.$attr[a])||(this.$attr[a]=e=wc(a,"-"));g=ta(this.$$element);if("a"===g&&"href"===a||"img"===g&&"src"===a)this[a]=b=M(b,"src"===a);else if("img"===g&&"srcset"===a){for(var g="",h=T(b),k=/(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/,
k=/\s/.test(h)?k:/(,)/,h=h.split(k),k=Math.floor(h.length/2),l=0;l<k;l++)var s=2*l,g=g+M(T(h[s]),!0),g=g+(" "+T(h[s+1]));h=T(h[2*l]).split(/\s/);g+=M(T(h[0]),!0);2===h.length&&(g+=" "+T(h[1]));this[a]=b=g}!1!==d&&(null===b||b===u?this.$$element.removeAttr(e):this.$$element.attr(e,b));(a=this.$$observers)&&m(a[f],function(a){try{a(b)}catch(d){c(d)}})},$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers=ma()),e=d[a]||(d[a]=[]);e.push(b);p.$evalAsync(function(){!e.$$inter&&c.hasOwnProperty(a)&&
b(c[a])});return function(){Wa(e,b)}}};var da=b.startSymbol(),ea=b.endSymbol(),fa="{{"==da||"}}"==ea?Sa:function(a){return a.replace(/\{\{/g,da).replace(/}}/g,ea)},ja=/^ngAttr[A-Z]/;D.$$addBindingInfo=k?function(a,b){var c=a.data("$binding")||[];F(b)?c=c.concat(b):c.push(b);a.data("$binding",c)}:B;D.$$addBindingClass=k?function(a){L(a,"ng-binding")}:B;D.$$addScopeInfo=k?function(a,b,c,d){a.data(c?d?"$isolateScopeNoTemplate":"$isolateScope":"$scope",b)}:B;D.$$addScopeClass=k?function(a,b){L(a,b?"ng-isolate-scope":
"ng-scope")}:B;return D}]}function xa(b){return cb(b.replace(Tc,""))}function Vc(b,a){var c="",d=b.split(/\s+/),e=a.split(/\s+/),f=0;a:for(;f<d.length;f++){for(var g=d[f],h=0;h<e.length;h++)if(g==e[h])continue a;c+=(0<c.length?" ":"")+g}return c}function Uc(b){b=C(b);var a=b.length;if(1>=a)return b;for(;a--;)8===b[a].nodeType&&zf.call(b,a,1);return b}function Oe(){var b={},a=!1;this.register=function(a,d){Ma(a,"controller");H(a)?O(b,a):b[a]=d};this.allowGlobals=function(){a=!0};this.$get=["$injector",
...
e)});return g};g.error=function(a){g.then(null,function(b){a(b.data,b.status,b.headers,e)});return g};return g}function q(c,f){function l(b,c,d,e){function f(){p(c,b,d,e)}L&&(200<=b&&300>b?L.put(Q,[b,c,Xc(d),e]):L.remove(Q));a?g.$applyAsync(f):(f(),g.$$phase||g.$apply())}function p(a,b,d,e){b=Math.max(b,0);(200<=b&&300>b?z.resolve:z.reject)({data:a,status:b,headers:Yc(d),config:c,statusText:e})}function q(a){p(a.data,a.status,ea(a.headers()),a.statusText)}function r(){var a=k.pendingRequests.indexOf(c);
-1!==a&&k.pendingRequests.splice(a,1)}var z=h.defer(),M=z.promise,L,D,m=c.headers,Q=n(c.url,c.params);k.pendingRequests.push(c);M.then(r,r);!c.cache&&!b.cache||!1===c.cache||"GET"!==c.method&&"JSONP"!==c.method||(L=H(c.cache)?c.cache:H(b.cache)?b.cache:s);L&&(D=L.get(Q),A(D)?D&&G(D.then)?D.then(q,q):F(D)?p(D[1],D[0],ea(D[2]),D[3]):p(D,200,{},"OK"):L.put(Q,M));x(D)&&((D=$c(c.url)?e()[c.xsrfCookieName||b.xsrfCookieName]:u)&&(m[c.xsrfHeaderName||b.xsrfHeaderName]=D),d(c.method,Q,f,l,m,c.timeout,c.withCredentials,
c.responseType));return M}function n(a,b){if(!b)return a;var c=[];Md(b,function(a,b){null===a||x(a)||(F(a)||(a=[a]),m(a,function(a){H(a)&&(a=da(a)?a.toISOString():Ya(a));c.push(Ea(b)+"="+Ea(a))}))});0<c.length&&(a+=(-1==a.indexOf("?")?"?":"&")+c.join("&"));return a}var s=f("$http"),r=[];m(c,function(a){r.unshift(J(a)?l.get(a):l.invoke(a))});k.pendingRequests=[];(function(a){m(arguments,function(a){k[a]=function(b,c){return k(O(c||{},{method:a,url:b}))}})})("get","delete","head","jsonp");(function(a){m(arguments,
...
a;else if(null==a)c="";else{switch(typeof a){case "string":break;case "number":a=""+a;break;default:a=Ya(a)}c=a}return c}catch(g){c=$b("interr",f,g.toString()),d(c)}}q=!!q;for(var p,w,m=0,z=[],M=[],L=f.length,D=[],X=[];m<L;)if(-1!=(p=f.indexOf(b,m))&&-1!=(w=f.indexOf(a,p+l)))m!==p&&D.push(g(f.substring(m,p))),m=f.substring(p+l,w),z.push(m),M.push(c(m,v)),m=w+k,X.push(D.length),D.push("");else{m!==L&&D.push(g(f.substring(m)));break}if(n&&1<D.length)throw $b("noconcat",f);if(!h||z.length){var Q=function(a){for(var b=
...
function ac(b){b=b.split("/");for(var a=b.length;a--;)b[a]=jb(b[a]);return b.join("/")}function ad(b,a){var c=Aa(b);a.$$protocol=c.protocol;a.$$host=c.hostname;a.$$port=$(c.port)||Gf[c.protocol]||null}function bd(b,a){var c="/"!==b.charAt(0);c&&(b="/"+b);var d=Aa(b);a.$$path=decodeURIComponent(c&&"/"===d.pathname.charAt(0)?d.pathname.substring(1):d.pathname);a.$$search=tc(d.search);a.$$hash=decodeURIComponent(d.hash);a.$$path&&"/"!=a.$$path.charAt(0)&&(a.$$path="/"+a.$$path)}function ya(b,a){if(0===
a.indexOf(b))return a.substr(b.length)}function Ha(b){var a=b.indexOf("#");return-1==a?b:b.substr(0,a)}function zb(b){return b.replace(/(#.+)|#$/,"$1")}function bc(b){return b.substr(0,Ha(b).lastIndexOf("/")+1)}function cc(b,a){this.$$html5=!0;a=a||"";var c=bc(b);ad(b,this);this.$$parse=function(a){var b=ya(c,a);if(!J(b))throw Ab("ipthprfx",a,c);bd(b,this);this.$$path||(this.$$path="/");this.$$compose()};this.$$compose=function(){var a=Ob(this.$$search),b=this.$$hash?"#"+jb(this.$$hash):"";this.$$url=
ac(this.$$path)+(a?"?"+a:"")+b;this.$$absUrl=c+this.$$url.substr(1)};this.$$parseLinkUrl=function(d,e){if(e&&"#"===e[0])return this.hash(e.slice(1)),!0;var f,g;(f=ya(b,d))!==u?(g=f,g=(f=ya(a,f))!==u?c+(ya("/",f)||f):b+g):(f=ya(c,d))!==u?g=c+f:c==d+"/"&&(g=c);g&&this.$$parse(g);return!!g}}function dc(b,a){var c=bc(b);ad(b,this);this.$$parse=function(d){d=ya(b,d)||ya(c,d);var e;"#"===d.charAt(0)?(e=ya(a,d),x(e)&&(e=d)):e=this.$$html5?d:"";bd(e,this);d=this.$$path;var f=/^\/[A-Z]:(\/.*)/;0===e.indexOf(b)&&
...
info:e("info"),warn:e("warn"),error:e("error"),debug:function(){var c=e("debug");return function(){b&&c.apply(a,arguments)}}()}}]}function Ba(b,a){if("__defineGetter__"===b||"__defineSetter__"===b||"__lookupGetter__"===b||"__lookupSetter__"===b||"__proto__"===b)throw ca("isecfld",a);return b}function ja(b,a){if(b){if(b.constructor===b)throw ca("isecfn",a);if(b.window===b)throw ca("isecwindow",a);if(b.children&&(b.nodeName||b.prop&&b.attr&&b.find))throw ca("isecdom",a);if(b===Object)throw ca("isecobj",
...
a){this.astBuilder=b;this.$filter=a}function Cb(b,a,c,d){ja(b,d);a=a.split(".");for(var e,f=0;1<a.length;f++){e=Ba(a.shift(),d);var g=ja(b[e],d);g||(g={},b[e]=g);b=g}e=Ba(a.shift(),d);ja(b[e],d);return b[e]=c}function Db(b){return"constructor"==b}function ec(b){return G(b.valueOf)?b.valueOf():Lf.call(b)}function Xe(){var b=ma(),a=ma();this.$get=["$filter","$sniffer",function(c,d){function e(a,b){return null==a||null==b?a===b:"object"===typeof a&&(a=ec(a),"object"===typeof a)?!1:a===b||a!==a&&b!==
...
1);return function(){0<=Wa(k,l)&&s(g,-1);d=null}},$watchGroup:function(a,b){function c(){h=!1;k?(k=!1,b(e,e,g)):b(e,d,g)}var d=Array(a.length),e=Array(a.length),f=[],g=this,h=!1,k=!0;if(!a.length){var l=!0;g.$evalAsync(function(){l&&b(e,e,g)});return function(){l=!1}}if(1===a.length)return this.$watch(a[0],function(a,c,f){e[0]=a;d[0]=c;b(e,a===c?e:d,f)});m(a,function(a,b){var k=g.$watch(a,function(a,f){e[b]=a;d[b]=f;h||(h=!0,g.$evalAsync(c))});f.push(k)});return function(){for(;f.length;)f.shift()()}},
$watchCollection:function(a,b){function c(a){e=a;var b,d,g,h;if(!x(e)){if(H(e))if(Qa(e))for(f!==q&&(f=q,r=f.length=0,l++),a=e.length,r!==a&&(l++,f.length=r=a),b=0;b<a;b++)h=f[b],g=e[b],d=h!==h&&g!==g,d||h===g||(l++,f[b]=g);else{f!==s&&(f=s={},r=0,l++);a=0;for(b in e)e.hasOwnProperty(b)&&(a++,g=e[b],h=f[b],b in f?(d=h!==h&&g!==g,d||h===g||(l++,f[b]=g)):(r++,f[b]=g,l++));if(r>a)for(b in l++,f)e.hasOwnProperty(b)||(r--,delete f[b])}else f!==e&&(f=e,l++);return l}}c.$stateful=!0;var d=this,e,f,g,k=1<
b.length,l=0,n=h(a,c),q=[],s={},p=!0,r=0;return this.$watch(n,function(){p?(p=!1,b(e,e,d)):b(e,g,d);if(k)if(H(e))if(Qa(e)){g=Array(e.length);for(var a=0;a<e.length;a++)g[a]=e[a]}else for(a in g={},e)uc.call(e,a)&&(g[a]=e[a]);else g=e})},$digest:function(){var b,f,h,k,q,s,r=a,m,z=[],v,x;n("$digest");l.$$checkUrlChange();this===p&&null!==e&&(l.defer.cancel(e),t());d=null;do{s=!1;for(m=this;w.length;){try{x=w.shift(),x.scope.$eval(x.expression,x.locals)}catch(A){g(A)}d=null}a:do{if(k=m.$$watchers)for(q=
k.length;q--;)try{if(b=k[q])if((f=b.get(m))!==(h=b.last)&&!(b.eq?ka(f,h):"number"===typeof f&&"number"===typeof h&&isNaN(f)&&isNaN(h)))s=!0,d=b,b.last=b.eq?ua(f,null):f,b.fn(f,h===y?f:h,m),5>r&&(v=4-r,z[v]||(z[v]=[]),z[v].push({msg:G(b.exp)?"fn: "+(b.exp.name||b.exp.toString()):b.exp,newVal:f,oldVal:h}));else if(b===d){s=!1;break a}}catch(B){g(B)}if(!(k=m.$$watchersCount&&m.$$childHead||m!==this&&m.$$nextSibling))for(;m!==this&&!(k=m.$$nextSibling);)m=m.$parent}while(m=k);if((s||w.length)&&!r--)throw p.$$phase=
...
u||""===b)return b;if("string"!==typeof b)throw Ca("itype",a);return new c(b)},getTrusted:function(c,e){if(null===e||e===u||""===e)return e;var g=h.hasOwnProperty(c)?h[c]:null;if(g&&e instanceof g)return e.$$unwrapTrustedValue();if(c===oa.RESOURCE_URL){var g=Aa(e.toString()),n,s,r=!1;n=0;for(s=b.length;n<s;n++)if(d(b[n],g)){r=!0;break}if(r)for(n=0,s=a.length;n<s;n++)if(d(a[n],g)){r=!1;break}if(r)return e;throw Ca("insecurl",e.toString());}if(c===oa.HTML)return f(e);throw Ca("unsafe");},valueOf:function(a){return a instanceof
g?a.$$unwrapTrustedValue():a}}}]}function af(){var b=!0;this.enabled=function(a){arguments.length&&(b=!!a);return b};this.$get=["$parse","$sceDelegate",function(a,c){if(b&&8>eb)throw Ca("iequirks");var d=ea(oa);d.isEnabled=function(){return b};d.trustAs=c.trustAs;d.getTrusted=c.getTrusted;d.valueOf=c.valueOf;b||(d.trustAs=d.getTrusted=function(a,b){return b},d.valueOf=Sa);d.parseAs=function(b,c){var e=a(c);return e.literal&&e.constant?e:a(c,function(a){return d.getTrusted(b,a)})};var e=d.parseAs,
f=d.getTrusted,g=d.trustAs;m(oa,function(a,b){var c=K(b);d[cb("parse_as_"+c)]=function(b){return e(a,b)};d[cb("get_trusted_"+c)]=function(b){return f(a,b)};d[cb("trust_as_"+c)]=function(b){return g(a,b)}});return d}]}function cf(){this.$get=["$window","$document",function(b,a){var c={},d=$((/android (\d+)/.exec(K((b.navigator||{}).userAgent))||[])[1]),e=/Boxee/i.test((b.navigator||{}).userAgent),f=a[0]||{},g,h=/^(Moz|webkit|ms)(?=[A-Z])/,l=f.body&&f.body.style,k=!1,q=!1;if(l){for(var n in l)if(k=
h.exec(n)){g=k[0];g=g.substr(0,1).toUpperCase()+g.substr(1);break}g||(g="WebkitOpacity"in l&&"webkit");k=!!("transition"in l||g+"Transition"in l);q=!!("animation"in l||g+"Animation"in l);!d||k&&q||(k=J(l.webkitTransition),q=J(l.webkitAnimation))}return{history:!(!b.history||!b.history.pushState||4>d||e),hasEvent:function(a){if("input"===a&&11>=eb)return!1;if(x(c[a])){var b=f.createElement("div");c[a]="on"+a in b}return c[a]},csp:ab(),vendorPrefix:g,transitions:k,animations:q,android:d}}]}function ef(){this.$get=
...
f.cancel=function(b){return b&&b.$$timeoutId in g?(g[b.$$timeoutId].reject("canceled"),delete g[b.$$timeoutId],a.defer.cancel(b.$$timeoutId)):!1};return f}]}function Aa(b){eb&&(Y.setAttribute("href",b),b=Y.href);Y.setAttribute("href",b);return{href:Y.href,protocol:Y.protocol?Y.protocol.replace(/:$/,""):"",host:Y.host,search:Y.search?Y.search.replace(/^\?/,""):"",hash:Y.hash?Y.hash.replace(/^#/,""):"",hostname:Y.hostname,port:Y.port,pathname:"/"===Y.pathname.charAt(0)?Y.pathname:"/"+Y.pathname}}function $c(b){b=
J(b)?Aa(b):b;return b.protocol===pd.protocol&&b.host===pd.host}function hf(){this.$get=qa(P)}function qd(b){function a(a){try{return decodeURIComponent(a)}catch(b){return a}}var c=b[0],d={},e="";return function(){var b,g,h,l,k;if(c.cookie!==e)for(e=c.cookie,b=e.split("; "),d={},h=0;h<b.length;h++)g=b[h],l=g.indexOf("="),0<l&&(k=a(g.substring(0,l)),d[k]===u&&(d[k]=a(g.substring(l+1))));return d}}function nf(){this.$get=qd}function Gc(b){function a(c,d){if(H(c)){var e={};m(c,function(b,c){e[c]=a(c,
...
break;default:return b}return b.filter(a)}}function Sf(b,a,c){var d=H(b)&&"$"in b;!0===a?a=ka:G(a)||(a=function(a,b){var c;!(c=H(b))&&(c=H(a))&&(c=a,c=!(G(c.toString)&&c.toString!==Object.prototype.toString));if(c)return!1;a=K(""+a);b=K(""+b);return-1!==a.indexOf(b)});return function(e){return d&&!H(e)?Ia(e,b.$,a,!1):Ia(e,b,a,c)}}function Ia(b,a,c,d,e){var f=null!==b?typeof b:"null",g=null!==a?typeof a:"null";if("string"===g&&"!"===a.charAt(0))return!Ia(b,a.substring(1),c,d);if(F(b))return b.some(function(b){return Ia(b,
...
return function(c,e,f){var g="",h=[],l,k;e=e||"mediumDate";e=b.DATETIME_FORMATS[e]||e;J(c)&&(c=Tf.test(c)?$(c):a(c));R(c)&&(c=new Date(c));if(!da(c)||!isFinite(c.getTime()))return c;for(;e;)(k=Uf.exec(e))?(h=Xa(h,k,1),e=h.pop()):(h.push(e),e=null);var q=c.getTimezoneOffset();f&&(q=rc(f,c.getTimezoneOffset()),c=Nb(c,f,!0));m(h,function(a){l=Vf[a];g+=l?l(c,b.DATETIME_FORMATS,q):a.replace(/(^'|'$)/g,"").replace(/''/g,"'")});return g}}function Of(){return function(b,a){x(a)&&(a=2);return Ya(b,a)}}function Pf(){return function(b,
a,c){a=Infinity===Math.abs(Number(a))?Number(a):$(a);if(isNaN(a))return b;R(b)&&(b=b.toString());if(!F(b)&&!J(b))return b;c=!c||isNaN(c)?0:$(c);c=0>c&&c>=-b.length?b.length+c:c;return 0<=a?b.slice(c,c+a):0===c?b.slice(a,b.length):b.slice(Math.max(0,c+a),c)}}function ud(b){return function(a,c,d){function e(a,b){return b?function(b,c){return a(c,b)}:a}function f(a){switch(typeof a){case "number":case "boolean":case "string":return!0;default:return!1}}function g(a){return null===a?"null":"function"===
typeof a.valueOf&&(a=a.valueOf(),f(a))||"function"===typeof a.toString&&(a=a.toString(),f(a))?a:""}function h(a,b){var c=typeof a,d=typeof b;c===d&&"object"===c&&(a=g(a),b=g(b));return c===d?("string"===c&&(a=a.toLowerCase(),b=b.toLowerCase()),a===b?0:a<b?-1:1):c<d?-1:1}if(!Qa(a))return a;c=F(c)?c:[c];0===c.length&&(c=["+"]);c=c.map(function(a){var c=!1,d=a||Sa;if(J(a)){if("+"==a.charAt(0)||"-"==a.charAt(0))c="-"==a.charAt(0),a=a.substring(1);if(""===a)return e(h,c);d=b(a);if(d.constant){var f=d();
...
!1;f.$submitted=!1;h.$addControl(f);f.$rollbackViewValue=function(){m(g,function(a){a.$rollbackViewValue()})};f.$commitViewValue=function(){m(g,function(a){a.$commitViewValue()})};f.$addControl=function(a){Ma(a.$name,"input");g.push(a);a.$name&&(f[a.$name]=a)};f.$$renameControl=function(a,b){var c=a.$name;f[c]===a&&delete f[c];f[b]=a;a.$name=b};f.$removeControl=function(a){a.$name&&f[a.$name]===a&&delete f[a.$name];m(f.$pending,function(b,c){f.$setValidity(c,null,a)});m(f.$error,function(b,c){f.$setValidity(c,
null,a)});m(f.$$success,function(b,c){f.$setValidity(c,null,a)});Wa(g,a)};Ad({ctrl:this,$element:b,set:function(a,b,c){var d=a[b];d?-1===d.indexOf(c)&&d.push(c):a[b]=[c]},unset:function(a,b,c){var d=a[b];d&&(Wa(d,c),0===d.length&&delete a[b])},parentForm:h,$animate:d});f.$setDirty=function(){d.removeClass(b,Pa);d.addClass(b,Hb);f.$dirty=!0;f.$pristine=!1;h.$setDirty()};f.$setPristine=function(){d.setClass(b,Pa,Hb+" ng-submitted");f.$dirty=!1;f.$pristine=!0;f.$submitted=!1;m(g,function(a){a.$setPristine()})};
...
f;if(da(c))return c;if(J(c)){'"'==c.charAt(0)&&'"'==c.charAt(c.length-1)&&(c=c.substring(1,c.length-1));if(Wf.test(c))return new Date(c);b.lastIndex=0;if(e=b.exec(c))return e.shift(),f=d?{yyyy:d.getFullYear(),MM:d.getMonth()+1,dd:d.getDate(),HH:d.getHours(),mm:d.getMinutes(),ss:d.getSeconds(),sss:d.getMilliseconds()/1E3}:{yyyy:1970,MM:1,dd:1,HH:0,mm:0,ss:0,sss:0},m(e,function(b,c){c<a.length&&(f[a[c]]=+b)}),new Date(f.yyyy,f.MM-1,f.dd,f.HH,f.mm,f.ss||0,1E3*f.sss||0)}return NaN}}function gb(b,a,c,
d){return function(e,f,g,h,l,k,q){function n(a){return a&&!(a.getTime&&a.getTime()!==a.getTime())}function s(a){return A(a)?da(a)?a:c(a):u}Bd(e,f,g,h);fb(e,f,g,h,l,k);var r=h&&h.$options&&h.$options.timezone,m;h.$$parserName=b;h.$parsers.push(function(b){return h.$isEmpty(b)?null:a.test(b)?(b=c(b,m),r&&(b=Nb(b,r)),b):u});h.$formatters.push(function(a){if(a&&!da(a))throw Jb("datefmt",a);if(n(a))return(m=a)&&r&&(m=Nb(m,r,!0)),q("date")(a,d,r);m=null;return""});if(A(g.min)||g.ngMin){var t;h.$validators.min=
...
function jc(b,a){b="ngClass"+b;return["$animate",function(c){function d(a,b){var c=[],d=0;a:for(;d<a.length;d++){for(var e=a[d],q=0;q<b.length;q++)if(e==b[q])continue a;c.push(e)}return c}function e(a){if(F(a))return a.join(" ").split(" ");if(J(a))return a.split(" ");if(H(a)){var b=[];m(a,function(a,c){a&&(b=b.concat(c.split(" ")))});return b}return a}return{restrict:"AC",link:function(f,g,h){function l(a,b){var c=g.data("$classCounts")||{},d=[];m(a,function(a){if(0<b||c[a])c[a]=(c[a]||0)+b,c[a]===
+(0<b)&&d.push(a)});g.data("$classCounts",c);return d.join(" ")}function k(b){if(!0===a||f.$index%2===a){var k=e(b||[]);if(!q){var r=l(k,1);h.$addClass(r)}else if(!ka(b,q)){var m=e(q),r=d(k,m),k=d(m,k),r=l(r,1),k=l(k,-1);r&&r.length&&c.addClass(g,r);k&&k.length&&c.removeClass(g,k)}}q=ea(b)}var q;f.$watch(h[b],k,!0);h.$observe("class",function(a){k(f.$eval(h[b]))});"ngClass"!==b&&f.$watch("$index",function(c,d){var g=c&1;if(g!==(d&1)){var k=e(f.$eval(h[b]));g===a?(g=l(k,1),h.$addClass(g)):(g=l(k,-1),
h.$removeClass(g))}})}}}]}function Ad(b){function a(a,b){b&&!f[a]?(k.addClass(e,a),f[a]=!0):!b&&f[a]&&(k.removeClass(e,a),f[a]=!1)}function c(b,c){b=b?"-"+wc(b,"-"):"";a(hb+b,!0===c);a(Dd+b,!1===c)}var d=b.ctrl,e=b.$element,f={},g=b.set,h=b.unset,l=b.parentForm,k=b.$animate;f[Dd]=!(f[hb]=e.hasClass(hb));d.$setValidity=function(b,e,f){e===u?(d.$pending||(d.$pending={}),g(d.$pending,b,f)):(d.$pending&&h(d.$pending,b,f),Ed(d.$pending)&&(d.$pending=u));Va(e)?e?(h(d.$error,b,f),g(d.$$success,b,f)):(g(d.$error,
b,f),h(d.$$success,b,f)):(h(d.$error,b,f),h(d.$$success,b,f));d.$pending?(a(Fd,!0),d.$valid=d.$invalid=u,c("",null)):(a(Fd,!1),d.$valid=Ed(d.$error),d.$invalid=!d.$valid,c("",d.$valid));e=d.$pending&&d.$pending[b]?u:d.$error[b]?!1:d.$$success[b]?!0:null;c(b,e);l.$setValidity(b,e,d)}}function Ed(b){if(b)for(var a in b)return!1;return!0}var Xf=/^\/(.+)\/([a-z]*)$/,K=function(b){return J(b)?b.toLowerCase():b},uc=Object.prototype.hasOwnProperty,nb=function(b){return J(b)?b.toUpperCase():b},eb,C,la,ra=
[].slice,zf=[].splice,Yf=[].push,sa=Object.prototype.toString,Da=E("ng"),aa=P.angular||(P.angular={}),bb,ib=0;eb=W.documentMode;B.$inject=[];Sa.$inject=[];var F=Array.isArray,oc=/^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/,T=function(b){return J(b)?b.trim():b},nd=function(b){return b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")},ab=function(){if(A(ab.isActive_))return ab.isActive_;var b=!(!W.querySelector("[ng-csp]")&&
!W.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return ab.isActive_=b},kb=function(){if(A(kb.name_))return kb.name_;var b,a,c=Ka.length,d,e;for(a=0;a<c;++a)if(d=Ka[a],b=W.querySelector("["+d.replace(":","\\:")+"jq]")){e=b.getAttribute(d+"jq");break}return kb.name_=e},Ka=["ng-","data-ng-","ng:","x-ng-"],Vd=/[A-Z]/g,xc=!1,Pb,pa=1,Za=3,Zd={full:"1.4.0-build.3911+sha.e57138d",major:1,minor:4,dot:0,codeName:"snapshot"};S.expando="ng339";var sb=S.cache={},tf=1;S._data=function(b){return this.cache[b[this.expando]]||
{}};var of=/([\:\-\_]+(.))/g,pf=/^moz([A-Z])/,Zf={mouseleave:"mouseout",mouseenter:"mouseover"},Sb=E("jqLite"),sf=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Rb=/<|&#?\w+;/,qf=/<([\w:]+)/,rf=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,fa={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};
fa.optgroup=fa.option;fa.tbody=fa.tfoot=fa.colgroup=fa.caption=fa.thead;fa.th=fa.td;var La=S.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===W.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),S(P).on("load",a))},toString:function(){var b=[];m(this,function(a){b.push(""+a)});return"["+b.join(", ")+"]"},eq:function(b){return 0<=b?C(this[b]):C(this[this.length+b])},length:0,push:Yf,sort:[].sort,splice:[].splice},xb={};m("multiple selected checked disabled readOnly required open".split(" "),
...
injector:function(b){return wb(b,"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:tb,css:function(b,a,c){a=cb(a);if(A(c))b.style[a]=c;else return b.style[a]},attr:function(b,a,c){var d=b.nodeType;if(d!==Za&&2!==d&&8!==d)if(d=K(a),xb[d])if(A(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||B).specified?d:u;else if(A(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,2),null===b?u:b},prop:function(b,
a,c){if(A(c))b[a]=c;else return b[a]},text:function(){function b(a,b){if(x(b)){var d=a.nodeType;return d===pa||d===Za?a.textContent:""}a.textContent=b}b.$dv="";return b}(),val:function(b,a){if(x(a)){if(b.multiple&&"select"===ta(b)){var c=[];m(b.options,function(a){a.selected&&c.push(a.value||a.text)});return 0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(x(a))return b.innerHTML;pb(b,!0);b.innerHTML=a},empty:Mc},function(b,a){S.prototype[a]=function(a,d){var e,f,g=this.length;
...
!0},isDefaultPrevented:function(){return!0===this.defaultPrevented},stopImmediatePropagation:function(){this.immediatePropagationStopped=!0},isImmediatePropagationStopped:function(){return!0===this.immediatePropagationStopped},stopPropagation:B,type:g,target:a},c.type&&(e=O(e,c)),c=ea(h),f=d?[e].concat(d):[e],m(c,function(c){e.isImmediatePropagationStopped()||c.apply(a,f)})}},function(a,c){S.prototype[c]=function(c,e,f){for(var g,h=0,l=this.length;h<l;h++)x(g)?(g=a(this[h],c,e,f),A(g)&&(g=C(g))):
Jc(g,a(this[h],c,e,f));return A(g)?g:this};S.prototype.bind=S.prototype.on;S.prototype.unbind=S.prototype.off});db.prototype={put:function(a,c){this[Fa(a,this.nextUid)]=c},get:function(a){return this[Fa(a,this.nextUid)]},remove:function(a){var c=this[a=Fa(a,this.nextUid)];delete this[a];return c}};var mf=[function(){this.$get=[function(){return db}]}],Rc=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,$f=/,/,ag=/^\s*(_?)(\S+?)\1\s*$/,Qc=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Ga=E("$injector");$a.$$annotate=function(a,
c,d){var e;if("function"===typeof a){if(!(e=a.$inject)){e=[];if(a.length){if(c)throw J(d)&&d||(d=a.name||xf(a)),Ga("strictdi",d);c=a.toString().replace(Qc,"");c=c.match(Rc);m(c[1].split($f),function(a){a.replace(ag,function(a,c,d){e.push(d)})})}a.$inject=e}}else F(a)?(c=a.length-1,lb(a[c],"fn"),e=a.slice(0,c)):lb(a,"fn",!0);return e};var bg=E("$animate"),Le=["$provide",function(a){this.$$selectors={};this.register=function(c,d){var e=c+"-animation";if(c&&"."!=c.charAt(0))throw bg("notcsel",c);this.$$selectors[c.substr(1)]=
e;a.factory(e,d)};this.classNameFilter=function(a){1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?a:null);return this.$$classNameFilter};this.$get=["$$q","$$asyncCallback","$rootScope",function(a,d,e){function f(d){var f,g=a.defer();g.promise.$$cancelFn=function(){f&&f()};e.$$postDigest(function(){f=d(function(){g.resolve()})});return g.promise}function g(a,c){var d=[],e=[],f=ma();m((a.attr("class")||"").split(/\s+/),function(a){f[a]=!0});m(c,function(a,c){var g=f[c];!1===a&&g?
...
""===a)&&this.path(decodeURIComponent(c[1]));(c[2]||c[1]||""===a)&&this.search(c[3]||"");this.hash(c[5]||"");return this},protocol:Bb("$$protocol"),host:Bb("$$host"),port:Bb("$$port"),path:dd("$$path",function(a){a=null!==a?a.toString():"";return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(J(a)||R(a))a=a.toString(),this.$$search=tc(a);else if(H(a))a=ua(a,{}),m(a,function(c,e){null==c&&delete a[e]}),this.$$search=a;else throw Ab("isrcharg");
...
a.watchId=c});this.state.computing="fn";this.stage="main";this.recurse(e);f='"'+this.USE+" "+this.STRICT+'";\n'+this.filterPrefix()+"var fn="+this.generateFunction("fn","s,l,a,i")+f+this.watchFns()+"return fn;";f=(new Function("$filter","ensureSafeMemberName","ensureSafeObject","ensureSafeFunction","ifDefined","plus","text",f))(this.$filter,Ba,ja,ed,Kf,fd,a);this.state=this.stage=u;f.literal=jd(e);f.constant=e.constant;return f},USE:"use",STRICT:"strict",watchFns:function(){var a=[],c=this.state.inputs,
...
c||this.nextId();k.recurse(a.test,c);k.if(c,k.lazyRecurse(a.alternate,c),k.lazyRecurse(a.consequent,c));e(c);break;case t.Identifier:c=c||this.nextId();d&&(d.context="inputs"===k.stage?"s":this.assign(this.nextId(),this.getHasOwnProperty("l",a.name)+"?l:s"),d.computed=!1,d.name=a.name);Ba(a.name);k.if("inputs"===k.stage||k.not(k.getHasOwnProperty("l",a.name)),function(){k.if("inputs"===k.stage||"s",function(){f&&1!==f&&k.if(k.not(k.nonComputedMember("s",a.name)),k.lazyAssign(k.nonComputedMember("s",
...
n=k.ensureSafeObject(k.computedMember(h,l)),k.assign(c,n),d&&(d.computed=!0,d.name=l);else{Ba(a.property.name);f&&1!==f&&k.if(k.not(k.nonComputedMember(h,a.property.name)),k.lazyAssign(k.nonComputedMember(h,a.property.name),"{}"));n=k.nonComputedMember(h,a.property.name);if(k.state.expensiveChecks||Db(a.property.name))n=k.ensureSafeObject(n);k.assign(c,n);d&&(d.computed=!1,d.name=a.property.name)}e(c)})},!!f);break;case t.CallExpression:c=c||this.nextId();a.filter?(l=k.filter(a.callee.name),q=[],
...
a+",text)"},ensureSafeMemberName:function(a){return"ensureSafeMemberName("+a+",text)"},ensureSafeFunction:function(a){return"ensureSafeFunction("+a+",text)"},lazyRecurse:function(a,c,d,e,f,g){var h=this;return function(){h.recurse(a,c,d,e,f,g)}},lazyAssign:function(a,c){var d=this;return function(){d.assign(a,c)}},stringEscapeRegex:/[^ a-zA-Z0-9]/g,stringEscapeFn:function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)},escape:function(a){if(J(a))return"'"+a.replace(this.stringEscapeRegex,
...
g,h,l)?c(f,g,h,l):d(f,g,h,l);return e?{value:f}:f}},value:function(a,c){return function(){return c?{context:u,name:u,value:a}:a}},identifier:function(a,c,d,e,f){return function(g,h,l,k){g=h&&a in h?h:g;e&&1!==e&&g&&!g[a]&&(g[a]={});h=g?g[a]:u;c&&ja(h,f);return d?{context:g,name:a,value:h}:h}},computedMember:function(a,c,d,e,f){return function(g,h,l,k){var q=a(g,h,l,k),n,m;null!=q&&(n=c(g,h,l,k),Ba(n,f),e&&1!==e&&q&&!q[n]&&(q[n]={}),m=q[n],ja(m,f));return d?{context:q,name:n,value:m}:m}},nonComputedMember:function(a,
c,d,e,f,g){return function(h,l,k,q){h=a(h,l,k,q);f&&1!==f&&h&&!h[c]&&(h[c]={});l=null!=h?h[c]:u;(d||Db(c))&&ja(l,g);return e?{context:h,name:c,value:l}:l}},inputs:function(a,c){return function(d,e,f,g){return g?g[c]:a(d,e,f)}}};var gc=function(a,c,d){this.lexer=a;this.$filter=c;this.options=d;this.ast=new t(this.lexer);this.astCompiler=d.csp?new ld(this.ast,c):new kd(this.ast,c)};gc.prototype={constructor:gc,parse:function(a){return this.astCompiler.compile(a,this.options.expensiveChecks)}};ma();
ma();var Lf=Object.prototype.valueOf,Ca=E("$sce"),oa={HTML:"html",CSS:"css",URL:"url",RESOURCE_URL:"resourceUrl",JS:"js"},ha=E("$compile"),Y=W.createElement("a"),pd=Aa(P.location.href);qd.$inject=["$document"];Gc.$inject=["$provide"];rd.$inject=["$locale"];td.$inject=["$locale"];var wd=".",Vf={yyyy:Z("FullYear",4),yy:Z("FullYear",2,0,!0),y:Z("FullYear",1),MMMM:Fb("Month"),MMM:Fb("Month",!0),MM:Z("Month",2,1),M:Z("Month",1,1),dd:Z("Date",2),d:Z("Date",1),HH:Z("Hours",2),H:Z("Hours",1),hh:Z("Hours",
...
Tf=/^\-?\d+$/;sd.$inject=["$locale"];var Qf=qa(K),Rf=qa(nb);ud.$inject=["$parse"];var be=qa({restrict:"E",compile:function(a,c){if(!c.href&&!c.xlinkHref)return function(a,c){if("a"===c[0].nodeName.toLowerCase()){var f="[object SVGAnimatedString]"===sa.call(c.prop("href"))?"xlink:href":"href";c.on("click",function(a){c.attr(f)||a.preventDefault()})}}}}),ob={};m(xb,function(a,c){function d(a,d,f){a.$watch(f[e],function(a){f.$set(c,!!a)})}if("multiple"!=a){var e=xa("ng-"+c),f=d;"checked"===a&&(f=function(a,
c,f){f.ngModel!==f[e]&&d(a,c,f)});ob[e]=function(){return{restrict:"A",priority:100,link:f}}}});m(Pc,function(a,c){ob[c]=function(){return{priority:100,link:function(a,e,f){if("ngPattern"===c&&"/"==f.ngPattern.charAt(0)&&(e=f.ngPattern.match(Xf))){f.$set("ngPattern",new RegExp(e[1],e[2]));return}a.$watch(f[c],function(a){f.$set(c,a)})}}}});m(["src","srcset","href"],function(a){var c=xa("ng-"+a);ob[c]=function(){return{priority:99,link:function(d,e,f){var g=a,h=a;"href"===a&&"[object SVGAnimatedString]"===
sa.call(e.prop("href"))&&(h="xlinkHref",f.$attr[h]="xlink:href",g=null);f.$observe(c,function(c){c?(f.$set(h,c),eb&&g&&e.prop(g,f[h])):"href"===a&&f.$set(h,null)})}}}});var Gb={$addControl:B,$$renameControl:function(a,c){a.$name=c},$removeControl:B,$setValidity:B,$setDirty:B,$setPristine:B,$setSubmitted:B};zd.$inject=["$element","$attrs","$scope","$animate","$interpolate"];var Gd=function(a){return["$timeout",function(c){return{name:"form",restrict:a?"EAC":"E",controller:zd,compile:function(d,e){d.addClass(Pa).addClass(hb);
...
Kd=/^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,Ld={text:function(a,c,d,e,f,g){fb(a,c,d,e,f,g);ic(e)},date:gb("date",Hd,Ib(Hd,["yyyy","MM","dd"]),"yyyy-MM-dd"),"datetime-local":gb("datetimelocal",Id,Ib(Id,"yyyy MM dd HH mm ss sss".split(" ")),"yyyy-MM-ddTHH:mm:ss.sss"),time:gb("time",Kd,Ib(Kd,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:gb("week",kc,function(a,c){if(da(a))return a;if(J(a)){kc.lastIndex=0;var d=kc.exec(a);if(d){var e=+d[1],f=+d[2],g=d=0,h=0,l=0,k=xd(e),f=7*(f-1);c&&(d=c.getHours(),g=
...
ke=jc("",!0),me=jc("Odd",0),le=jc("Even",1),ne=Ja({compile:function(a,c){c.$set("ngCloak",u);a.removeClass("ng-cloak")}}),oe=[function(){return{restrict:"A",scope:!0,controller:"@",priority:500}}],Fc={},jg={blur:!0,focus:!0};m("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=xa("ng-"+a);Fc[c]=["$parse","$rootScope",function(d,e){return{restrict:"A",compile:function(f,g){var h=
...
};this.$render=B;this.$isEmpty=function(a){return x(a)||""===a||null===a||a!==a};var w=e.inheritedData("$formController")||Gb,C=0;Ad({ctrl:this,$element:e,set:function(a,c){a[c]=!0},unset:function(a,c){delete a[c]},parentForm:w,$animate:g});this.$setPristine=function(){p.$dirty=!1;p.$pristine=!0;g.removeClass(e,Hb);g.addClass(e,Pa)};this.$setDirty=function(){p.$dirty=!0;p.$pristine=!1;g.removeClass(e,Pa);g.addClass(e,Hb);w.$setDirty()};this.$setUntouched=function(){p.$touched=!1;p.$untouched=!0;g.setClass(e,
...
p.$formatters,e=d.length,f=c;e--;)f=d[e](f);p.$viewValue!==f&&(p.$viewValue=p.$$lastCommittedViewValue=f,p.$render(),p.$$runValidators(c,f,B))}return c})}],Ee=["$rootScope",function(a){return{restrict:"A",require:["ngModel","^?form","^?ngModelOptions"],controller:kg,priority:1,compile:function(c){c.addClass(Pa).addClass("ng-untouched").addClass(hb);return{pre:function(a,c,f,g){var h=g[0],l=g[1]||Gb;h.$$setOptions(g[2]&&g[2].$options);l.$addControl(h);f.$observe("name",function(a){h.$name!==a&&l.$$renameControl(h,
...
!1,this.$options.updateOn=T(this.$options.updateOn.replace(lg,function(){d.$options.updateOnDefault=!0;return" "}))):this.$options.updateOnDefault=!0}]}},ue=Ja({terminal:!0,priority:1E3}),mg=E("ngOptions"),ng=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,Ce=["$compile","$parse",function(a,c){function d(a,d,e){function f(a,
c,d,e,g){this.selectValue=a;this.viewValue=c;this.label=d;this.group=e;this.disabled=g}var m=a.match(ng);if(!m)throw mg("iexp",a,va(d));var n=m[5]||m[7],s=m[6];a=/ as /.test(m[0])&&m[1];var r=m[9];d=c(m[2]?m[1]:n);var t=a&&c(a)||d,u=r&&c(r),v=r?function(a,c){return u(e,c)}:function(a){return Fa(a)},p=c(m[2]||m[1]),w=c(m[3]||""),x=c(m[4]||""),z=c(m[8]),M={},L=s?function(a,c){M[s]=c;M[n]=a;return M}:function(a){M[n]=a;return M};return{getWatchables:c(z,function(a){var c=[];a=a||[];Object.keys(a).forEach(function(d){var f=
...
if(!k)throw d("iidexp",q);var t=k[3]||k[1],x=k[2];if(s&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(s)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(s)))throw d("badident",s);var v,p,w,A,z={$id:Fa};r?v=a(r):(w=function(a,c){return Fa(c)},A=function(a){return a});return function(a,f,g,k,q){v&&(p=function(c,d,e){x&&(z[x]=c);z[t]=d;z.$index=e;return v(a,z)});var r=ma();a.$watchCollection(n,function(g){var k,n,v=f[0],z,B=ma(),D,G,H,F,J,E,K;s&&(a[s]=g);if(Qa(g))J=
g,n=p||w;else for(K in n=p||A,J=[],g)g.hasOwnProperty(K)&&"$"!==K.charAt(0)&&J.push(K);D=J.length;K=Array(D);for(k=0;k<D;k++)if(G=g===J?k:J[k],H=g[G],F=n(G,H,k),r[F])E=r[F],delete r[F],B[F]=E,K[k]=E;else{if(B[F])throw m(K,function(a){a&&a.scope&&(r[a.id]=a)}),d("dupes",h,F,H);K[k]={id:F,scope:u,clone:u};B[F]=!0}for(z in r){E=r[z];F=mb(E.clone);c.leave(F);if(F[0].parentNode)for(k=0,n=F.length;k<n;k++)F[k].$$NG_REMOVED=!0;E.scope.$destroy()}for(k=0;k<D;k++)if(G=g===J?k:J[k],H=g[G],E=K[k],E.scope){z=
...
(function() {
  ...
  nrtc = angular.module('NRTC', ['parse-angular', 'angularMoment', 'ui.bootstrap', 'GlobalConfigs']).config(function(GLOBAL_CONFIGS) {
    ...
    return window.setInterval(function() {
      return dataService.getHistory(100);
    }, 1000);
  });
  ...
  nrtc.controller("nrtcController", function($scope, PRICE) {
    ...
    return $scope.$on("historyLoaded", function(e, data) {
      data.forEach(function(card) {
        ...
        price = durationInMinutes < PRICE.discountPeriodInMinutes ? durationInMinutes * PRICE.priceBefore : PRICE.discountPeriodInMinutes * (PRICE.priceBefore - PRICE.priceAfter) + durationInMinutes * PRICE.priceAfter;
        card.durationInMinutes = durationInMinutes || 0;
        card.price = price || 0;
        return card.isOnline = card.timeExit === null;
      });
    ...
    getHistory = function(count) {
      ...
      return query.limit(count || 10).find({
        ...
        error: function(error) {
          return $rootScope.$broadcast('error', error);
        }
      });
    };
    return exports = {
...
(function() {
    'use strict';
    angular.module('NRTC').run(function($templateCache) {$templateCache.put("scripts/nrtc/template.html","<div class=\"container-fluid\"><div class=\"row\"><div class=\"col-md-10 col-md-offset-1\"><h1>Time Manager</h1><table class=\"table table-striped table-bordered table-hover table-condensed\"><thead><th>#</th><th>Code</th><th>Status</th><th>Enter Time</th><th>Exit Time</th><th>Duration (minutes)</th><th>Price</th></thead><tbody><tr ng-repeat=\"card in data | orderBy:[\'isOnline\',\'updatedAt\']:true\"><td>{{$index+1}}</td><td>{{card.code}}</td><td><div ng-class=\"{\'true\':\'label-success\',\'false\':\'label-default\'}[card.isOnline]\" class=\"label\">{{ {\'true\':\'Online\', \'false\':\'Offline\'}[card.isOnline] }}</div></td><td>{{card.timeEnter | amDateFormat:\'HH:mm:ss (MMMM D YYYY)\'}}</td><td>{{card.timeExit | amDateFormat:\'HH:mm:ss (MMMM D YYYY)\'}}</td><td><div ng-class=\"{\'true\':\'label-success\',\'false\':\'label-default\'}[card.isOnline]\" class=\"label\">{{card.durationInMinutes}}</div></td><td><div ng-class=\"{\'true\':\'label-success\',\'false\':\'label-info\'}[card.isOnline]\" class=\"label\">{{card.price}}</div></td></tr></tbody></table></div></div></div>");})}).call(this);